...
class simple_election__acceptor_2_proposer_1__finite {
  public:
    ...
    virtual ~simple_election__acceptor_2_proposer_1__finite();
    ...
    simple_election__acceptor_2_proposer_1__finite();
void __init();
