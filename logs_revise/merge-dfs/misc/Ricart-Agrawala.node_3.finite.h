...
class Ricart_Agrawala__node_3__finite {
  public:
    ...
    virtual ~Ricart_Agrawala__node_3__finite();
    ...
    bool replied[3][3];
    bool holds[3];
    Ricart_Agrawala__node_3__finite();
void __init();
    virtual void ext__request(node requester, node responder);
    virtual void ext__reply(node requester, node responder);
    virtual void ext__enter(node requester);
    virtual void ext__leave(node requester);
    virtual bool ext__get_holds(node n0);
    virtual bool ext__get_bool_holds(node n0, bool result);
    virtual bool ext__get_requested(node n0, node n1);
    virtual bool ext__get_bool_requested(node n0, node n1, bool result);
    virtual bool ext__get_replied(node n0, node n1);
    virtual bool ext__get_bool_replied(node n0, node n1, bool result);
