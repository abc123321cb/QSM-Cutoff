...
class quorum_leader_election_wo_maj__node_2__finite {
  public:
    ...
    virtual ~quorum_leader_election_wo_maj__node_2__finite();
    ...
    enum nset{nset__node0_node1};
    bool isleader[2];
    bool voted[2][2];
    bool member[2][1];
    nset quorum;
    quorum_leader_election_wo_maj__node_2__finite();
void __init();
