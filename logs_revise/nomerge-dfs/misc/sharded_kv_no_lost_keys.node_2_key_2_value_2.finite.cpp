#include "sharded_kv_no_lost_keys.node_2_key_2_value_2.finite.h"
...
#include <cstdint>
#endif
typedef sharded_kv_no_lost_keys__node_2_key_2_value_2__finite ivy_class;
...
void sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::install_reader(reader *r) {
    #ifdef _WIN32
...
void sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::install_thread(reader *r) {
    install_reader(r);
}

void sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::install_timer(timer *r) {
    #ifdef _WIN32
...
#ifdef _WIN32
    void sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::__lock() { WaitForSingleObject(mutex,INFINITE); }
    void sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::__unlock() { ReleaseMutex(mutex); }
#else
    void sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::__lock() { pthread_mutex_lock(&mutex); }
    void sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::__unlock() { pthread_mutex_unlock(&mutex); }
#endif
...
std::ostream &operator <<(std::ostream &s, const sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key &t);
template <>
sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key _arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(ivy_ser &res, const sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key&);
template <>
void  __deser<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(ivy_deser &inp, sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key &res);
std::ostream &operator <<(std::ostream &s, const sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node &t);
template <>
sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node _arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(ivy_ser &res, const sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node&);
template <>
void  __deser<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(ivy_deser &inp, sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node &res);
std::ostream &operator <<(std::ostream &s, const sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value &t);
template <>
sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value _arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value>(ivy_ser &res, const sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value&);
template <>
void  __deser<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value>(ivy_deser &inp, sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value &res);
int sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::___ivy_choose(int rng,const char *name,int id) {
        return 0;
    }
struct ivy_nondet_except {}; // lauren-yrluo added
void sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::__init(){
...
void sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::ext__reshard(key k, value v, node n_old, node n_new){
        ivy_assume(table[n_old][k][v], "sharded_kv_no_lost_keys.node_2_key_2_value_2.finite.ivy: line 19");
        table[n_old][k][v] = false;
        owner[n_old][k] = false;
        transfer_msg[n_new][k][v] = true;
}
void sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::ext__recv_transfer_msg(node n, key k, value v){
        ivy_assume(transfer_msg[n][k][v], "sharded_kv_no_lost_keys.node_2_key_2_value_2.finite.ivy: line 27");
        transfer_msg[n][k][v] = false;
        table[n][k][v] = true;
        owner[n][k] = true;
}
void sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::ext__put(node n, key k, value v){
        ivy_assume(owner[n][k], "sharded_kv_no_lost_keys.node_2_key_2_value_2.finite.ivy: line 35");
        bool __tmp2[2];
        for (int V = 0; V < 2; V++) {
            __tmp2[V] = (V == v);
        }
...
bool sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::ext__get_transfer_msg(node n0, key k1, value v2){
    bool qrm_result;
    qrm_result = transfer_msg[n0][k1][v2];
    return qrm_result;
}
bool sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::ext__get_bool_transfer_msg(node n0, key k1, value v2, bool result){
    bool qrm_result;
...
sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::sharded_kv_no_lost_keys__node_2_key_2_value_2__finite(){
#ifdef _WIN32
...
std::ostream &operator <<(std::ostream &s, const sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key &t){
    if (t == sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key0) s<<"key0";
    if (t == sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key1) s<<"key1";
    return s;
}
template <>
void  __ser<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(ivy_ser &res, const sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node &t){
    if (t == sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node0) s<<"node0";
    if (t == sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node1) s<<"node1";
    return s;
}
template <>
void  __ser<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(ivy_ser &res, const sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value &t){
    if (t == sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value0) s<<"value0";
    if (t == sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value1) s<<"value1";
    return s;
}
template <>
void  __ser<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value>(ivy_ser &res, const sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value&t){
    __ser(res,(int)t);
}
...
int ask_ret(long long bound) {
    ...
    class sharded_kv_no_lost_keys__node_2_key_2_value_2__finite_repl : public sharded_kv_no_lost_keys__node_2_key_2_value_2__finite {
    ...
    virtual void ivy_assume(bool truth,const char *msg){
        ...
        sharded_kv_no_lost_keys__node_2_key_2_value_2__finite_repl() : sharded_kv_no_lost_keys__node_2_key_2_value_2__finite(){}
...
sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key _arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ...
    if(arg.atom == "key0") return sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key0;
    if(arg.atom == "key1") return sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key1;
...
void __deser<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(ivy_deser &inp, sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key &res){
    int __res;
    __deser(inp,__res);
    res = (sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key)__res;
}
template <>
sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node _arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "node0") return sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node0;
    if(arg.atom == "node1") return sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node1;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(ivy_deser &inp, sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node &res){
    int __res;
    __deser(inp,__res);
    res = (sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node)__res;
}
template <>
sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value _arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "value0") return sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value0;
    if(arg.atom == "value1") return sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value1;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value>(ivy_deser &inp, sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value &res){
    int __res;
    __deser(inp,__res);
    res = (sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value)__res;
}
...
class cmd_reader: public stdin_reader {
    int lineno;
public:
    sharded_kv_no_lost_keys__node_2_key_2_value_2__finite_repl &ivy;    

    cmd_reader(sharded_kv_no_lost_keys__node_2_key_2_value_2__finite_repl &_ivy) : ivy(_ivy) {
        lineno = 1;
        if (isatty(fdes()))
        ...
        try {
            ...
            ivy.__lock();
                ...
                if (action == "get_bool_owner") {
                    ...
                    __ivy_out  << "= " << ivy.ext__get_bool_owner(_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(args,0,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(args,1,2),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_table") {
                    check_arity(args,4,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_table(_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(args,0,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(args,1,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value>(args,2,2),_arg<bool>(args,3,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_transfer_msg") {
                    check_arity(args,4,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_transfer_msg(_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(args,0,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(args,1,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value>(args,2,2),_arg<bool>(args,3,2)) << std::endl;
                }
                else
    
                if (action == "get_owner") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_owner(_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(args,0,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_table") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_table(_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(args,0,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(args,1,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_transfer_msg") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_transfer_msg(_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(args,0,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(args,1,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "put") {
                    check_arity(args,3,action);
                    ivy.ext__put(_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(args,0,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(args,1,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value>(args,2,2));
                }
                else
    
                if (action == "recv_transfer_msg") {
                    check_arity(args,3,action);
                    ivy.ext__recv_transfer_msg(_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(args,0,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(args,1,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value>(args,2,2));
                }
                else
    
                if (action == "reshard") {
                    check_arity(args,4,action);
                    ivy.ext__reshard(_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::key>(args,0,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::value>(args,1,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(args,2,2),_arg<sharded_kv_no_lost_keys__node_2_key_2_value_2__finite::node>(args,3,2));
                }
                else
...
int main(int argc, char **argv){
    ...
    if (argc != 1){
        std::cerr << "usage: sharded_kv_no_lost_keys__node_2_key_2_value_2__finite \n";
        __ivy_exit(1);
    }
...
#include <vector>
sharded_kv_no_lost_keys__node_2_key_2_value_2__finite_repl * ivy_exec;
cmd_reader* ivy_exec_cr;
std::ostringstream ivy_exec_stream;

void ivy_exec_init(){
	__ivy_out.basic_ios<char>::rdbuf(ivy_exec_stream.rdbuf());
	ivy_exec = new sharded_kv_no_lost_keys__node_2_key_2_value_2__finite_repl;
	ivy_exec -> __unlock();
...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[6]) >> ivy_exec -> table[0][1][0];
	std::stringstream(state_values[7]) >> ivy_exec -> table[0][1][1];
	std::stringstream(state_values[8]) >> ivy_exec -> table[1][0][0];
	std::stringstream(state_values[9]) >> ivy_exec -> table[1][0][1];
	std::stringstream(state_values[10]) >> ivy_exec -> table[1][1][0];
	std::stringstream(state_values[11]) >> ivy_exec -> table[1][1][1];
	std::stringstream(state_values[12]) >> ivy_exec -> transfer_msg[0][0][0];
	std::stringstream(state_values[13]) >> ivy_exec -> transfer_msg[0][0][1];
	std::stringstream(state_values[14]) >> ivy_exec -> transfer_msg[0][1][0];
	std::stringstream(state_values[15]) >> ivy_exec -> transfer_msg[0][1][1];
	std::stringstream(state_values[16]) >> ivy_exec -> transfer_msg[1][0][0];
	std::stringstream(state_values[17]) >> ivy_exec -> transfer_msg[1][0][1];
	std::stringstream(state_values[18]) >> ivy_exec -> transfer_msg[1][1][0];
	std::stringstream(state_values[19]) >> ivy_exec -> transfer_msg[1][1][1];
}
