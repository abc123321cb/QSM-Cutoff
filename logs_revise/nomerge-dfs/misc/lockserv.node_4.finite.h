...
class lockserv__node_4__finite {
  public:
    ...
    virtual ~lockserv__node_4__finite();
    ...
    bool unlock_msg[4];
    bool holds_lock[4];
    bool server_holds_lock;
    lockserv__node_4__finite();
void __init();
    virtual void ext__send_lock(node n);
    virtual void ext__recv_lock(node n);
    virtual void ext__recv_grant(node n);
    virtual void ext__unlock(node n);
    virtual void ext__recv_unlock(node n);
    virtual bool ext__get_unlock_msg(node n0);
    virtual bool ext__get_bool_unlock_msg(node n0, bool result);
    virtual bool ext__get_lock_msg(node n0);
    virtual bool ext__get_bool_lock_msg(node n0, bool result);
    virtual bool ext__get_grant_msg(node n0);
    virtual bool ext__get_bool_grant_msg(node n0, bool result);
    virtual bool ext__get_server_holds_lock();
    virtual bool ext__get_bool_server_holds_lock(bool result);
    virtual bool ext__get_holds_lock(node n0);
    virtual bool ext__get_bool_holds_lock(node n0, bool result);
