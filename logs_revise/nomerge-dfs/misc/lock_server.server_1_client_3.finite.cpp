...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[1]) >> ivy_exec -> link[1][0];
	std::stringstream(state_values[2]) >> ivy_exec -> link[2][0];
	std::stringstream(state_values[3]) >> ivy_exec -> semaphore[0];
}
