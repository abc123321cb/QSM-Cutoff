...
class lockserv_automaton__node_4__finite {
  public:
    ...
    virtual ~lockserv_automaton__node_4__finite();
    ...
    bool holds_lock[4];
    bool held;
    lockserv_automaton__node_4__finite();
void __init();
    virtual void ext__lock(node n);
    virtual void ext__unlock(node n);
    virtual void ext__recv_lock(node sender);
    virtual void ext__recv_grant(node n);
    virtual void ext__recv_unlock(node sender);
    ...
    virtual bool ext__get_held();
    virtual bool ext__get_bool_held(bool result);
