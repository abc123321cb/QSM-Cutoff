...
class simple_election__acceptor_4_proposer_3__finite {
  public:
    ...
    virtual ~simple_election__acceptor_4_proposer_3__finite();
    ...
    enum proposer{proposer0,proposer1,proposer2};
    bool member[4][4];
    bool start[3];
    bool promise[4][3];
    bool leader[3];
    ...
    simple_election__acceptor_4_proposer_3__finite();
void __init();
