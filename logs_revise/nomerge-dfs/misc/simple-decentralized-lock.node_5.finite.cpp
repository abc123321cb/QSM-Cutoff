#include "simple-decentralized-lock.node_5.finite.h"
...
#include <cstdint>
#endif
typedef simple_decentralized_lock__node_5__finite ivy_class;
...
void simple_decentralized_lock__node_5__finite::install_reader(reader *r) {
    #ifdef _WIN32
...
void simple_decentralized_lock__node_5__finite::install_thread(reader *r) {
    install_reader(r);
}

void simple_decentralized_lock__node_5__finite::install_timer(timer *r) {
    #ifdef _WIN32
...
#ifdef _WIN32
    void simple_decentralized_lock__node_5__finite::__lock() { WaitForSingleObject(mutex,INFINITE); }
    void simple_decentralized_lock__node_5__finite::__unlock() { ReleaseMutex(mutex); }
#else
    void simple_decentralized_lock__node_5__finite::__lock() { pthread_mutex_lock(&mutex); }
    void simple_decentralized_lock__node_5__finite::__unlock() { pthread_mutex_unlock(&mutex); }
#endif
...
std::ostream &operator <<(std::ostream &s, const simple_decentralized_lock__node_5__finite::node &t);
template <>
simple_decentralized_lock__node_5__finite::node _arg<simple_decentralized_lock__node_5__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<simple_decentralized_lock__node_5__finite::node>(ivy_ser &res, const simple_decentralized_lock__node_5__finite::node&);
template <>
void  __deser<simple_decentralized_lock__node_5__finite::node>(ivy_deser &inp, simple_decentralized_lock__node_5__finite::node &res);
int simple_decentralized_lock__node_5__finite::___ivy_choose(int rng,const char *name,int id) {
        return 0;
    }
struct ivy_nondet_except {}; // lauren-yrluo added
void simple_decentralized_lock__node_5__finite::__init(){
        bool __tmp0[5][5];
        ...
        bool __tmp1[5];
        for (int X = 0; X < 5; X++) {
            __tmp1[X] = (X == start_node);
        }
        for (int X = 0; X < 5; X++) {
            has_lock[X] = __tmp1[X];
        }
}
void simple_decentralized_lock__node_5__finite::ext__send(node src, node dst){
        ivy_assume(has_lock[src], "simple-decentralized-lock.node_5.finite.ivy: line 18");
        message[src][dst] = true;
        has_lock[src] = false;
}
void simple_decentralized_lock__node_5__finite::ext__recv(node src, node dst){
        ivy_assume(message[src][dst], "simple-decentralized-lock.node_5.finite.ivy: line 24");
        message[src][dst] = false;
        has_lock[dst] = true;
}
bool simple_decentralized_lock__node_5__finite::ext__get_has_lock(node n0){
    bool qrm_result;
    qrm_result = has_lock[n0];
    return qrm_result;
}
bool simple_decentralized_lock__node_5__finite::ext__get_bool_has_lock(node n0, bool result){
    bool qrm_result;
    qrm_result = (has_lock[n0] == result);
    return qrm_result;
}
simple_decentralized_lock__node_5__finite::node simple_decentralized_lock__node_5__finite::ext__get_start_node(){
    simple_decentralized_lock__node_5__finite::node qrm_result;
    qrm_result = start_node;
    return qrm_result;
}
bool simple_decentralized_lock__node_5__finite::ext__get_bool_start_node(node result){
    bool qrm_result;
    qrm_result = (start_node == result);
    return qrm_result;
}
bool simple_decentralized_lock__node_5__finite::ext__get_message(node n0, node n1){
    bool qrm_result;
    qrm_result = message[n0][n1];
    return qrm_result;
}
bool simple_decentralized_lock__node_5__finite::ext__get_bool_message(node n0, node n1, bool result){
    bool qrm_result;
    qrm_result = (message[n0][n1] == result);
    return qrm_result;
}
void simple_decentralized_lock__node_5__finite::__tick(int __timeout){
}
simple_decentralized_lock__node_5__finite::simple_decentralized_lock__node_5__finite(){
#ifdef _WIN32
...
message[X__0][X__1] = (bool)___ivy_choose(0,"init",0);
    }
}
for (node X__0 = (node)0; (int) X__0 < 5; X__0 = (node)(((int)X__0) + 1)) {
has_lock[X__0] = (bool)___ivy_choose(0,"init",0);
}
start_node = (node)___ivy_choose(0,"init",0);
}
simple_decentralized_lock__node_5__finite::~simple_decentralized_lock__node_5__finite(){
...
std::ostream &operator <<(std::ostream &s, const simple_decentralized_lock__node_5__finite::node &t){
    if (t == simple_decentralized_lock__node_5__finite::node0) s<<"node0";
    if (t == simple_decentralized_lock__node_5__finite::node1) s<<"node1";
    if (t == simple_decentralized_lock__node_5__finite::node2) s<<"node2";
    if (t == simple_decentralized_lock__node_5__finite::node3) s<<"node3";
    if (t == simple_decentralized_lock__node_5__finite::node4) s<<"node4";
    return s;
}
template <>
void  __ser<simple_decentralized_lock__node_5__finite::node>(ivy_ser &res, const simple_decentralized_lock__node_5__finite::node&t){
    __ser(res,(int)t);
}
...
int ask_ret(long long bound) {
    ...
    class simple_decentralized_lock__node_5__finite_repl : public simple_decentralized_lock__node_5__finite {
    ...
    virtual void ivy_assume(bool truth,const char *msg){
        ...
        simple_decentralized_lock__node_5__finite_repl() : simple_decentralized_lock__node_5__finite(){}
...
simple_decentralized_lock__node_5__finite::node _arg<simple_decentralized_lock__node_5__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ...
    if(arg.atom == "node0") return simple_decentralized_lock__node_5__finite::node0;
    if(arg.atom == "node1") return simple_decentralized_lock__node_5__finite::node1;
    if(arg.atom == "node2") return simple_decentralized_lock__node_5__finite::node2;
    if(arg.atom == "node3") return simple_decentralized_lock__node_5__finite::node3;
    if(arg.atom == "node4") return simple_decentralized_lock__node_5__finite::node4;
...
void __deser<simple_decentralized_lock__node_5__finite::node>(ivy_deser &inp, simple_decentralized_lock__node_5__finite::node &res){
    int __res;
    __deser(inp,__res);
    res = (simple_decentralized_lock__node_5__finite::node)__res;
}
...
class cmd_reader: public stdin_reader {
    int lineno;
public:
    simple_decentralized_lock__node_5__finite_repl &ivy;    

    cmd_reader(simple_decentralized_lock__node_5__finite_repl &_ivy) : ivy(_ivy) {
        lineno = 1;
        if (isatty(fdes()))
    ...
    virtual void process(const std::string &cmd) {
        ...
        try {
            ...
            ivy.__lock();
                ...
                if (action == "get_bool_has_lock") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_has_lock(_arg<simple_decentralized_lock__node_5__finite::node>(args,0,5),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_message") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_message(_arg<simple_decentralized_lock__node_5__finite::node>(args,0,5),_arg<simple_decentralized_lock__node_5__finite::node>(args,1,5),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_start_node") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_start_node(_arg<simple_decentralized_lock__node_5__finite::node>(args,0,5)) << std::endl;
                }
                else
    
                if (action == "get_has_lock") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_has_lock(_arg<simple_decentralized_lock__node_5__finite::node>(args,0,5)) << std::endl;
                }
                else
    
                if (action == "get_message") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_message(_arg<simple_decentralized_lock__node_5__finite::node>(args,0,5),_arg<simple_decentralized_lock__node_5__finite::node>(args,1,5)) << std::endl;
                }
                else
    
                if (action == "get_start_node") {
                    check_arity(args,0,action);
                    __ivy_out  << "= " << ivy.ext__get_start_node() << std::endl;
                }
                else
    
                if (action == "recv") {
                    check_arity(args,2,action);
                    ivy.ext__recv(_arg<simple_decentralized_lock__node_5__finite::node>(args,0,5),_arg<simple_decentralized_lock__node_5__finite::node>(args,1,5));
                }
                else
    
                if (action == "send") {
                    check_arity(args,2,action);
                    ivy.ext__send(_arg<simple_decentralized_lock__node_5__finite::node>(args,0,5),_arg<simple_decentralized_lock__node_5__finite::node>(args,1,5));
                }
                else
...
int main(int argc, char **argv){
    ...
    if (argc != 1){
        std::cerr << "usage: simple_decentralized_lock__node_5__finite \n";
        __ivy_exit(1);
    }
...
#include <vector>
simple_decentralized_lock__node_5__finite_repl * ivy_exec;
cmd_reader* ivy_exec_cr;
std::ostringstream ivy_exec_stream;

void ivy_exec_init(){
	__ivy_out.basic_ios<char>::rdbuf(ivy_exec_stream.rdbuf());
	ivy_exec = new simple_decentralized_lock__node_5__finite_repl;
	ivy_exec -> __unlock();
...
void ivy_exec_set_state(std::vector<std::string> state_values){
	std::stringstream(state_values[0]) >> ivy_exec -> has_lock[0];
	std::stringstream(state_values[1]) >> ivy_exec -> has_lock[1];
	std::stringstream(state_values[2]) >> ivy_exec -> has_lock[2];
	std::stringstream(state_values[3]) >> ivy_exec -> has_lock[3];
	std::stringstream(state_values[4]) >> ivy_exec -> has_lock[4];
	std::stringstream(state_values[5]) >> ivy_exec -> message[0][0];
	std::stringstream(state_values[6]) >> ivy_exec -> message[0][1];
	std::stringstream(state_values[7]) >> ivy_exec -> message[0][2];
	std::stringstream(state_values[8]) >> ivy_exec -> message[0][3];
	std::stringstream(state_values[9]) >> ivy_exec -> message[0][4];
	std::stringstream(state_values[10]) >> ivy_exec -> message[1][0];
	std::stringstream(state_values[11]) >> ivy_exec -> message[1][1];
	std::stringstream(state_values[12]) >> ivy_exec -> message[1][2];
	std::stringstream(state_values[13]) >> ivy_exec -> message[1][3];
	std::stringstream(state_values[14]) >> ivy_exec -> message[1][4];
	std::stringstream(state_values[15]) >> ivy_exec -> message[2][0];
	std::stringstream(state_values[16]) >> ivy_exec -> message[2][1];
	std::stringstream(state_values[17]) >> ivy_exec -> message[2][2];
	std::stringstream(state_values[18]) >> ivy_exec -> message[2][3];
	std::stringstream(state_values[19]) >> ivy_exec -> message[2][4];
	std::stringstream(state_values[20]) >> ivy_exec -> message[3][0];
	std::stringstream(state_values[21]) >> ivy_exec -> message[3][1];
	std::stringstream(state_values[22]) >> ivy_exec -> message[3][2];
	std::stringstream(state_values[23]) >> ivy_exec -> message[3][3];
	std::stringstream(state_values[24]) >> ivy_exec -> message[3][4];
	std::stringstream(state_values[25]) >> ivy_exec -> message[4][0];
	std::stringstream(state_values[26]) >> ivy_exec -> message[4][1];
	std::stringstream(state_values[27]) >> ivy_exec -> message[4][2];
	std::stringstream(state_values[28]) >> ivy_exec -> message[4][3];
	std::stringstream(state_values[29]) >> ivy_exec -> message[4][4];
	{
		ivy_value arg; arg.pos = 0; arg.atom = state_values[30];
		std::vector<ivy_value> args; args.push_back(arg);
		ivy_exec -> start_node = _arg<simple_decentralized_lock__node_5__finite::node>(args, 0, 0);
	}
}
