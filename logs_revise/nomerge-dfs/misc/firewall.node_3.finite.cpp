...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[3]) >> ivy_exec -> internal[0];
	std::stringstream(state_values[4]) >> ivy_exec -> internal[1];
	std::stringstream(state_values[5]) >> ivy_exec -> internal[2];
	std::stringstream(state_values[6]) >> ivy_exec -> sent[0][0];
	std::stringstream(state_values[7]) >> ivy_exec -> sent[0][1];
	std::stringstream(state_values[8]) >> ivy_exec -> sent[0][2];
	std::stringstream(state_values[9]) >> ivy_exec -> sent[1][0];
	std::stringstream(state_values[10]) >> ivy_exec -> sent[1][1];
	std::stringstream(state_values[11]) >> ivy_exec -> sent[1][2];
	std::stringstream(state_values[12]) >> ivy_exec -> sent[2][0];
	std::stringstream(state_values[13]) >> ivy_exec -> sent[2][1];
	std::stringstream(state_values[14]) >> ivy_exec -> sent[2][2];
}
