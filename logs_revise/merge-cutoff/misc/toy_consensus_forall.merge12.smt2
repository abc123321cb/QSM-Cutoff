...
(assert
 ...
 (let (($x90 (not $x34)))
 (let (($x36 (= |VALUE0:value| |VALUE2:value|)))
 (let (($x37 (not $x36)))
 (let (($x27 (= |NODE0:node| |NODE1:node|)))
 (let (($x28 (not $x27)))
 (let (($x26 (= |NODE1:node| |NODE2:node|)))
 (let (($x11 (not $x26)))
 (let (($x24 (= |NODE0:node| |NODE2:node|)))
 (let (($x9 (not $x24)))
 (let (($x40 (or (and $x9 $x11 $x28 $x33 $x90) (and $x9 $x11 $x28 $x37 $x90 $x38))))
