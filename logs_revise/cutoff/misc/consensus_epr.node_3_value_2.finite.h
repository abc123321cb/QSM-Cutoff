...
class consensus_epr__node_3_value_2__finite {
  public:
    ...
    virtual ~consensus_epr__node_3_value_2__finite();
    ...
    consensus_epr__node_3_value_2__finite();
void __init();
