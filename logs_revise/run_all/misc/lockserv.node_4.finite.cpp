...
void ivy_exec_set_state(std::vector<std::string> state_values){
	std::stringstream(state_values[0]) >> ivy_exec -> grant_msg[0];
	std::stringstream(state_values[1]) >> ivy_exec -> grant_msg[1];
	std::stringstream(state_values[2]) >> ivy_exec -> grant_msg[2];
	std::stringstream(state_values[3]) >> ivy_exec -> grant_msg[3];
	std::stringstream(state_values[4]) >> ivy_exec -> holds_lock[0];
	std::stringstream(state_values[5]) >> ivy_exec -> holds_lock[1];
	std::stringstream(state_values[6]) >> ivy_exec -> holds_lock[2];
	std::stringstream(state_values[7]) >> ivy_exec -> holds_lock[3];
	std::stringstream(state_values[8]) >> ivy_exec -> lock_msg[0];
	std::stringstream(state_values[9]) >> ivy_exec -> lock_msg[1];
	std::stringstream(state_values[10]) >> ivy_exec -> lock_msg[2];
	std::stringstream(state_values[11]) >> ivy_exec -> lock_msg[3];
	std::stringstream(state_values[12]) >> ivy_exec -> server_holds_lock;
	std::stringstream(state_values[13]) >> ivy_exec -> unlock_msg[0];
	std::stringstream(state_values[14]) >> ivy_exec -> unlock_msg[1];
	std::stringstream(state_values[15]) >> ivy_exec -> unlock_msg[2];
	std::stringstream(state_values[16]) >> ivy_exec -> unlock_msg[3];
}
