...
class sharded_kv_no_lost_keys__node_3_key_1_value_4__finite {
  public:
    ...
    virtual ~sharded_kv_no_lost_keys__node_3_key_1_value_4__finite();
    ...
    bool table[3][1][4];
    bool owner[3][1];
    bool transfer_msg[3][1][4];
    sharded_kv_no_lost_keys__node_3_key_1_value_4__finite();
void __init();
