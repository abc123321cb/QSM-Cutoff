...
class simple_election__acceptor_3_proposer_3__finite {
  public:
    ...
    virtual ~simple_election__acceptor_3_proposer_3__finite();
    ...
    simple_election__acceptor_3_proposer_3__finite();
void __init();
