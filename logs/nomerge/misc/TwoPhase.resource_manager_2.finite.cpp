#include "TwoPhase.resource_manager_2.finite.h"
...
#include <cstdint>
#endif
typedef TwoPhase__resource_manager_2__finite ivy_class;
...
void TwoPhase__resource_manager_2__finite::install_reader(reader *r) {
    #ifdef _WIN32
...
void TwoPhase__resource_manager_2__finite::install_thread(reader *r) {
    install_reader(r);
}

void TwoPhase__resource_manager_2__finite::install_timer(timer *r) {
    #ifdef _WIN32
...
#ifdef _WIN32
    void TwoPhase__resource_manager_2__finite::__lock() { WaitForSingleObject(mutex,INFINITE); }
    void TwoPhase__resource_manager_2__finite::__unlock() { ReleaseMutex(mutex); }
#else
    void TwoPhase__resource_manager_2__finite::__lock() { pthread_mutex_lock(&mutex); }
    void TwoPhase__resource_manager_2__finite::__unlock() { pthread_mutex_unlock(&mutex); }
#endif
...
std::ostream &operator <<(std::ostream &s, const TwoPhase__resource_manager_2__finite::resource_manager &t);
template <>
TwoPhase__resource_manager_2__finite::resource_manager _arg<TwoPhase__resource_manager_2__finite::resource_manager>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<TwoPhase__resource_manager_2__finite::resource_manager>(ivy_ser &res, const TwoPhase__resource_manager_2__finite::resource_manager&);
template <>
void  __deser<TwoPhase__resource_manager_2__finite::resource_manager>(ivy_deser &inp, TwoPhase__resource_manager_2__finite::resource_manager &res);
int TwoPhase__resource_manager_2__finite::___ivy_choose(int rng,const char *name,int id) {
        return 0;
    }
struct ivy_nondet_except {}; // lauren-yrluo added
void TwoPhase__resource_manager_2__finite::__init(){
        bool __tmp0[2];
        for (int R = 0; R < 2; R++) {
            __tmp0[R] = true;
        }
...
void TwoPhase__resource_manager_2__finite::ext__tMRcvPrepared(resource_manager rm){
        ivy_assume(tm_init, "TwoPhase.resource_manager_2.finite.ivy: line 36");
        ivy_assume(msg_prepared[rm], "TwoPhase.resource_manager_2.finite.ivy: line 37");
        tm_prepared[rm] = true;
}
void TwoPhase__resource_manager_2__finite::ext__tMCommit(){
        ivy_assume(tm_init, "TwoPhase.resource_manager_2.finite.ivy: line 42");
        int __tmp6;
        __tmp6 = 1;
        for (int R = 0; R < 2; R++) {
            if (!tm_prepared[R]) __tmp6 = 0;
        }
        ivy_assume(__tmp6, "TwoPhase.resource_manager_2.finite.ivy: line 43");
        tm_init = false;
        tm_committed = true;
        tm_aborted = false;
        msg_commit = true;
}
void TwoPhase__resource_manager_2__finite::ext__tMAbort(){
        ivy_assume(tm_init, "TwoPhase.resource_manager_2.finite.ivy: line 51");
        tm_init = false;
        tm_committed = false;
        tm_aborted = true;
        msg_abort = true;
}
void TwoPhase__resource_manager_2__finite::ext__rMPrepare(resource_manager rm){
        ivy_assume(working[rm], "TwoPhase.resource_manager_2.finite.ivy: line 59");
        working[rm] = false;
        prepared[rm] = true;
        committed[rm] = false;
        aborted[rm] = false;
...
void TwoPhase__resource_manager_2__finite::ext__rMChooseToAbort(resource_manager rm){
        ivy_assume(working[rm], "TwoPhase.resource_manager_2.finite.ivy: line 68");
        working[rm] = false;
        prepared[rm] = false;
        committed[rm] = false;
        aborted[rm] = true;
}
void TwoPhase__resource_manager_2__finite::ext__rMRcvCommitMsg(resource_manager rm){
        ivy_assume(msg_commit, "TwoPhase.resource_manager_2.finite.ivy: line 76");
        working[rm] = false;
        prepared[rm] = false;
        committed[rm] = true;
        aborted[rm] = false;
}
void TwoPhase__resource_manager_2__finite::ext__rMRcvAbortMsg(resource_manager rm){
        ivy_assume(msg_abort, "TwoPhase.resource_manager_2.finite.ivy: line 84");
        working[rm] = false;
        prepared[rm] = false;
        committed[rm] = false;
        aborted[rm] = true;
...
bool TwoPhase__resource_manager_2__finite::ext__get_bool_tm_init(bool result){
    bool qrm_result;
...
bool TwoPhase__resource_manager_2__finite::ext__get_aborted(resource_manager r0){
    bool qrm_result;
    qrm_result = aborted[r0];
    return qrm_result;
}
bool TwoPhase__resource_manager_2__finite::ext__get_bool_aborted(resource_manager r0, bool result){
    bool qrm_result;
...
bool TwoPhase__resource_manager_2__finite::ext__get_msg_commit(){
    bool qrm_result;
    qrm_result = msg_commit;
    return qrm_result;
}
bool TwoPhase__resource_manager_2__finite::ext__get_bool_msg_commit(bool result){
    bool qrm_result;
...
bool TwoPhase__resource_manager_2__finite::ext__get_bool_working(resource_manager r0, bool result){
    bool qrm_result;
...
TwoPhase__resource_manager_2__finite::TwoPhase__resource_manager_2__finite(){
#ifdef _WIN32
...
#endif
__lock();
for (resource_manager X__0 = (resource_manager)0; (int) X__0 < 2; X__0 = (resource_manager)(((int)X__0) + 1)) {
...
std::ostream &operator <<(std::ostream &s, const TwoPhase__resource_manager_2__finite::resource_manager &t){
    if (t == TwoPhase__resource_manager_2__finite::resource_manager0) s<<"resource_manager0";
    if (t == TwoPhase__resource_manager_2__finite::resource_manager1) s<<"resource_manager1";
    return s;
}
template <>
void  __ser<TwoPhase__resource_manager_2__finite::resource_manager>(ivy_ser &res, const TwoPhase__resource_manager_2__finite::resource_manager&t){
    __ser(res,(int)t);
}
...
int ask_ret(long long bound) {
    ...
    class TwoPhase__resource_manager_2__finite_repl : public TwoPhase__resource_manager_2__finite {
    ...
    virtual void ivy_assume(bool truth,const char *msg){
        ...
        TwoPhase__resource_manager_2__finite_repl() : TwoPhase__resource_manager_2__finite(){}
...
TwoPhase__resource_manager_2__finite::resource_manager _arg<TwoPhase__resource_manager_2__finite::resource_manager>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ...
    if(arg.atom == "resource_manager0") return TwoPhase__resource_manager_2__finite::resource_manager0;
    if(arg.atom == "resource_manager1") return TwoPhase__resource_manager_2__finite::resource_manager1;
...
void __deser<TwoPhase__resource_manager_2__finite::resource_manager>(ivy_deser &inp, TwoPhase__resource_manager_2__finite::resource_manager &res){
    int __res;
    __deser(inp,__res);
    res = (TwoPhase__resource_manager_2__finite::resource_manager)__res;
}
...
class cmd_reader: public stdin_reader {
    int lineno;
public:
    TwoPhase__resource_manager_2__finite_repl &ivy;    

    cmd_reader(TwoPhase__resource_manager_2__finite_repl &_ivy) : ivy(_ivy) {
        lineno = 1;
        if (isatty(fdes()))
        ...
        try {
            ...
            ivy.__lock();
                ...
                if (action == "get_aborted") {
                    ...
                    __ivy_out  << "= " << ivy.ext__get_aborted(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_aborted") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_aborted(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_committed") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_committed(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2),_arg<bool>(args,1,2)) << std::endl;
                }
                else
                ...
                if (action == "get_bool_msg_prepared") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_msg_prepared(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_prepared") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_prepared(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2),_arg<bool>(args,1,2)) << std::endl;
                }
                else
                ...
                if (action == "get_bool_tm_prepared") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_tm_prepared(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_working") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_working(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_committed") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_committed(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2)) << std::endl;
                }
                else
                ...
                if (action == "get_msg_prepared") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_msg_prepared(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2)) << std::endl;
                }
                else
    
                if (action == "get_prepared") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_prepared(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2)) << std::endl;
                }
                else
                ...
                if (action == "get_tm_prepared") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_tm_prepared(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2)) << std::endl;
                }
                else
    
                if (action == "get_working") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_working(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2)) << std::endl;
                }
                else
    
                if (action == "rMChooseToAbort") {
                    check_arity(args,1,action);
                    ivy.ext__rMChooseToAbort(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2));
                }
                else
    
                if (action == "rMPrepare") {
                    check_arity(args,1,action);
                    ivy.ext__rMPrepare(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2));
                }
                else
    
                if (action == "rMRcvAbortMsg") {
                    check_arity(args,1,action);
                    ivy.ext__rMRcvAbortMsg(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2));
                }
                else
    
                if (action == "rMRcvCommitMsg") {
                    check_arity(args,1,action);
                    ivy.ext__rMRcvCommitMsg(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2));
                }
                else
                ...
                if (action == "tMRcvPrepared") {
                    check_arity(args,1,action);
                    ivy.ext__tMRcvPrepared(_arg<TwoPhase__resource_manager_2__finite::resource_manager>(args,0,2));
                }
                else
...
int main(int argc, char **argv){
    ...
    if (argc != 1){
        std::cerr << "usage: TwoPhase__resource_manager_2__finite \n";
        __ivy_exit(1);
    }
...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[1]) >> ivy_exec -> aborted[1];
	std::stringstream(state_values[2]) >> ivy_exec -> committed[0];
	std::stringstream(state_values[3]) >> ivy_exec -> committed[1];
	std::stringstream(state_values[4]) >> ivy_exec -> msg_abort;
	std::stringstream(state_values[5]) >> ivy_exec -> msg_commit;
	std::stringstream(state_values[6]) >> ivy_exec -> msg_prepared[0];
	std::stringstream(state_values[7]) >> ivy_exec -> msg_prepared[1];
	std::stringstream(state_values[8]) >> ivy_exec -> prepared[0];
	std::stringstream(state_values[9]) >> ivy_exec -> prepared[1];
	std::stringstream(state_values[10]) >> ivy_exec -> tm_aborted;
	std::stringstream(state_values[11]) >> ivy_exec -> tm_committed;
	std::stringstream(state_values[12]) >> ivy_exec -> tm_init;
	std::stringstream(state_values[13]) >> ivy_exec -> tm_prepared[0];
	std::stringstream(state_values[14]) >> ivy_exec -> tm_prepared[1];
	std::stringstream(state_values[15]) >> ivy_exec -> working[0];
	std::stringstream(state_values[16]) >> ivy_exec -> working[1];
}
