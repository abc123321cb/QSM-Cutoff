...
class sharded_kv_no_lost_keys__node_1_key_2_value_1__finite {
  public:
    ...
    virtual ~sharded_kv_no_lost_keys__node_1_key_2_value_1__finite();
    ...
    bool table[1][2][1];
    bool owner[1][2];
    bool transfer_msg[1][2][1];
    sharded_kv_no_lost_keys__node_1_key_2_value_1__finite();
void __init();
