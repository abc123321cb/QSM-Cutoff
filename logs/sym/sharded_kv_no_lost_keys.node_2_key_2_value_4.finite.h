...
class sharded_kv_no_lost_keys__node_2_key_2_value_4__finite {
  public:
    ...
    virtual ~sharded_kv_no_lost_keys__node_2_key_2_value_4__finite();
    ...
    bool table[2][2][4];
    bool owner[2][2];
    bool transfer_msg[2][2][4];
    sharded_kv_no_lost_keys__node_2_key_2_value_4__finite();
void __init();
