...
class sharded_kv_no_lost_keys__node_4_key_2_value_3__finite {
  public:
    ...
    virtual ~sharded_kv_no_lost_keys__node_4_key_2_value_3__finite();
    ...
    bool table[4][2][3];
    bool owner[4][2];
    bool transfer_msg[4][2][3];
    sharded_kv_no_lost_keys__node_4_key_2_value_3__finite();
void __init();
