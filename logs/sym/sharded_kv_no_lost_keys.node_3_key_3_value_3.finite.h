...
class sharded_kv_no_lost_keys__node_3_key_3_value_3__finite {
  public:
    ...
    virtual ~sharded_kv_no_lost_keys__node_3_key_3_value_3__finite();
    ...
    bool table[3][3][3];
    bool owner[3][3];
    bool transfer_msg[3][3][3];
    sharded_kv_no_lost_keys__node_3_key_3_value_3__finite();
void __init();
