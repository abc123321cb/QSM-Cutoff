...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[2]) >> ivy_exec -> replied[1][0];
	std::stringstream(state_values[3]) >> ivy_exec -> replied[1][1];
	std::stringstream(state_values[4]) >> ivy_exec -> holds[0];
	std::stringstream(state_values[5]) >> ivy_exec -> holds[1];
