...
class lock_server__server_3_client_2__finite {
  public:
    ...
    virtual ~lock_server__server_3_client_2__finite();
    ...
    enum client{client0,client1};
    enum server{server0,server1,server2};
    bool link[2][3];
    bool semaphore[3];
    lock_server__server_3_client_2__finite();
void __init();
