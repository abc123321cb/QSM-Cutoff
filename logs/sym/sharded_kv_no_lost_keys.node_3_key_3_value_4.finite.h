...
class sharded_kv_no_lost_keys__node_3_key_3_value_4__finite {
  public:
    ...
    virtual ~sharded_kv_no_lost_keys__node_3_key_3_value_4__finite();
    ...
    bool table[3][3][4];
    bool owner[3][3];
    bool transfer_msg[3][3][4];
    sharded_kv_no_lost_keys__node_3_key_3_value_4__finite();
void __init();
