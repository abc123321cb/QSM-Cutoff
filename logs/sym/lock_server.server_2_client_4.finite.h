...
class lock_server__server_2_client_4__finite {
  public:
    ...
    virtual ~lock_server__server_2_client_4__finite();
    ...
    enum server{server0,server1};
    bool link[4][2];
    bool semaphore[2];
    lock_server__server_2_client_4__finite();
void __init();
