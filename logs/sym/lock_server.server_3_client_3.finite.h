...
class lock_server__server_3_client_3__finite {
  public:
    ...
    virtual ~lock_server__server_3_client_3__finite();
    ...
    enum client{client0,client1,client2};
    enum server{server0,server1,server2};
    bool link[3][3];
    bool semaphore[3];
    lock_server__server_3_client_3__finite();
void __init();
