...
class sharded_kv_no_lost_keys__node_4_key_3_value_4__finite {
  public:
    ...
    virtual ~sharded_kv_no_lost_keys__node_4_key_3_value_4__finite();
    ...
    enum key{key0,key1,key2};
    enum value{value0,value1,value2,value3};
    enum node{node0,node1,node2,node3};
    bool table[4][3][4];
    bool owner[4][3];
    bool transfer_msg[4][3][4];
    sharded_kv_no_lost_keys__node_4_key_3_value_4__finite();
void __init();
    virtual void ext__reshard(key k, value v, node n_old, node n_new);
    virtual void ext__recv_transfer_msg(node n, key k, value v);
    virtual void ext__put(node n, key k, value v);
    virtual bool ext__get_owner(node n0, key k1);
    virtual bool ext__get_bool_owner(node n0, key k1, bool result);
    virtual bool ext__get_table(node n0, key k1, value v2);
    virtual bool ext__get_bool_table(node n0, key k1, value v2, bool result);
    virtual bool ext__get_transfer_msg(node n0, key k1, value v2);
    virtual bool ext__get_bool_transfer_msg(node n0, key k1, value v2, bool result);
