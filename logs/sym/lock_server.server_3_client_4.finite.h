...
class lock_server__server_3_client_4__finite {
  public:
    ...
    virtual ~lock_server__server_3_client_4__finite();
    ...
    enum client{client0,client1,client2,client3};
    enum server{server0,server1,server2};
    bool link[4][3];
    bool semaphore[3];
    lock_server__server_3_client_4__finite();
void __init();
