...
class sharded_kv_no_lost_keys__node_2_key_3_value_3__finite {
  public:
    ...
    virtual ~sharded_kv_no_lost_keys__node_2_key_3_value_3__finite();
    ...
    bool table[2][3][3];
    bool owner[2][3];
    bool transfer_msg[2][3][3];
    sharded_kv_no_lost_keys__node_2_key_3_value_3__finite();
void __init();
