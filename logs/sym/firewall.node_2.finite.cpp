...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[2]) >> ivy_exec -> sent[1][0];
	std::stringstream(state_values[3]) >> ivy_exec -> sent[1][1];
	std::stringstream(state_values[4]) >> ivy_exec -> internal[0];
	std::stringstream(state_values[5]) >> ivy_exec -> internal[1];
	std::stringstream(state_values[6]) >> ivy_exec -> allowed_in[0];
	std::stringstream(state_values[7]) >> ivy_exec -> allowed_in[1];
}
