...
class sharded_kv_no_lost_keys__node_4_key_3_value_2__finite {
  public:
    ...
    virtual ~sharded_kv_no_lost_keys__node_4_key_3_value_2__finite();
    ...
    bool table[4][3][2];
    bool owner[4][3];
    bool transfer_msg[4][3][2];
    sharded_kv_no_lost_keys__node_4_key_3_value_2__finite();
void __init();
