...
class TwoPhase__resource_manager_1__finite {
  public:
    ...
    virtual ~TwoPhase__resource_manager_1__finite();
    ...
    enum resource_manager{resource_manager0};
    bool working[1];
    bool prepared[1];
    bool committed[1];
    bool aborted[1];
    ...
    bool msg_commit;
    bool msg_abort;
    TwoPhase__resource_manager_1__finite();
void __init();
