#include "client_server_ae.node_1_request_1_response_1.finite.h"
...
#include <cstdint>
#endif
typedef client_server_ae__node_1_request_1_response_1__finite ivy_class;
...
void client_server_ae__node_1_request_1_response_1__finite::install_reader(reader *r) {
    #ifdef _WIN32
...
void client_server_ae__node_1_request_1_response_1__finite::install_thread(reader *r) {
    install_reader(r);
}

void client_server_ae__node_1_request_1_response_1__finite::install_timer(timer *r) {
    #ifdef _WIN32
...
#ifdef _WIN32
    void client_server_ae__node_1_request_1_response_1__finite::__lock() { WaitForSingleObject(mutex,INFINITE); }
    void client_server_ae__node_1_request_1_response_1__finite::__unlock() { ReleaseMutex(mutex); }
#else
    void client_server_ae__node_1_request_1_response_1__finite::__lock() { pthread_mutex_lock(&mutex); }
    void client_server_ae__node_1_request_1_response_1__finite::__unlock() { pthread_mutex_unlock(&mutex); }
#endif
...
std::ostream &operator <<(std::ostream &s, const client_server_ae__node_1_request_1_response_1__finite::node &t);
template <>
client_server_ae__node_1_request_1_response_1__finite::node _arg<client_server_ae__node_1_request_1_response_1__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<client_server_ae__node_1_request_1_response_1__finite::node>(ivy_ser &res, const client_server_ae__node_1_request_1_response_1__finite::node&);
template <>
void  __deser<client_server_ae__node_1_request_1_response_1__finite::node>(ivy_deser &inp, client_server_ae__node_1_request_1_response_1__finite::node &res);
std::ostream &operator <<(std::ostream &s, const client_server_ae__node_1_request_1_response_1__finite::request &t);
template <>
client_server_ae__node_1_request_1_response_1__finite::request _arg<client_server_ae__node_1_request_1_response_1__finite::request>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<client_server_ae__node_1_request_1_response_1__finite::request>(ivy_ser &res, const client_server_ae__node_1_request_1_response_1__finite::request&);
template <>
void  __deser<client_server_ae__node_1_request_1_response_1__finite::request>(ivy_deser &inp, client_server_ae__node_1_request_1_response_1__finite::request &res);
std::ostream &operator <<(std::ostream &s, const client_server_ae__node_1_request_1_response_1__finite::response &t);
template <>
client_server_ae__node_1_request_1_response_1__finite::response _arg<client_server_ae__node_1_request_1_response_1__finite::response>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<client_server_ae__node_1_request_1_response_1__finite::response>(ivy_ser &res, const client_server_ae__node_1_request_1_response_1__finite::response&);
template <>
void  __deser<client_server_ae__node_1_request_1_response_1__finite::response>(ivy_deser &inp, client_server_ae__node_1_request_1_response_1__finite::response &res);
int client_server_ae__node_1_request_1_response_1__finite::___ivy_choose(int rng,const char *name,int id) {
        return 0;
    }
bool client_server_ae__node_1_request_1_response_1__finite::responseMatched(node N, response P){
    bool val;
    int __tmp0;
    __tmp0 = 0;
    for (int R = 0; R < 1; R++) {
...
void client_server_ae__node_1_request_1_response_1__finite::__init(){
...
void client_server_ae__node_1_request_1_response_1__finite::ext__new_request(node n, request r){
    request_sent[n][r] = true;
}
void client_server_ae__node_1_request_1_response_1__finite::ext__respond(node n, request r, response p){
        ivy_assume(request_sent[n][r], "client_server_ae.node_1_request_1_response_1.finite.ivy: line 34");
        ivy_assume(match[r][p], "client_server_ae.node_1_request_1_response_1.finite.ivy: line 35");
        response_sent[n][p] = true;
}
void client_server_ae__node_1_request_1_response_1__finite::ext__receive_response(node n, response p){
...
bool client_server_ae__node_1_request_1_response_1__finite::ext__get_bool_response_sent(node n0, response r1, bool result){
    bool qrm_result;
    qrm_result = (response_sent[n0][r1] == result);
    return qrm_result;
}
bool client_server_ae__node_1_request_1_response_1__finite::ext__get_request_sent(node n0, request r1){
    bool qrm_result;
...
bool client_server_ae__node_1_request_1_response_1__finite::ext__get_bool_response_received(node n0, response r1, bool result){
    bool qrm_result;
    qrm_result = (response_received[n0][r1] == result);
    return qrm_result;
}
void client_server_ae__node_1_request_1_response_1__finite::__tick(int __timeout){
}
client_server_ae__node_1_request_1_response_1__finite::client_server_ae__node_1_request_1_response_1__finite(){
#ifdef _WIN32
...
std::ostream &operator <<(std::ostream &s, const client_server_ae__node_1_request_1_response_1__finite::node &t){
    if (t == client_server_ae__node_1_request_1_response_1__finite::node0) s<<"node0";
    return s;
}
template <>
void  __ser<client_server_ae__node_1_request_1_response_1__finite::node>(ivy_ser &res, const client_server_ae__node_1_request_1_response_1__finite::node&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const client_server_ae__node_1_request_1_response_1__finite::request &t){
    if (t == client_server_ae__node_1_request_1_response_1__finite::request0) s<<"request0";
    return s;
}
template <>
void  __ser<client_server_ae__node_1_request_1_response_1__finite::request>(ivy_ser &res, const client_server_ae__node_1_request_1_response_1__finite::request&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const client_server_ae__node_1_request_1_response_1__finite::response &t){
    if (t == client_server_ae__node_1_request_1_response_1__finite::response0) s<<"response0";
    return s;
}
template <>
void  __ser<client_server_ae__node_1_request_1_response_1__finite::response>(ivy_ser &res, const client_server_ae__node_1_request_1_response_1__finite::response&t){
    __ser(res,(int)t);
}
...
int ask_ret(long long bound) {
    ...
    class client_server_ae__node_1_request_1_response_1__finite_repl : public client_server_ae__node_1_request_1_response_1__finite {
    ...
    virtual void ivy_assume(bool truth,const char *msg){
        ...
        client_server_ae__node_1_request_1_response_1__finite_repl() : client_server_ae__node_1_request_1_response_1__finite(){}
...
client_server_ae__node_1_request_1_response_1__finite::node _arg<client_server_ae__node_1_request_1_response_1__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ...
    if(arg.atom == "node0") return client_server_ae__node_1_request_1_response_1__finite::node0;
...
void __deser<client_server_ae__node_1_request_1_response_1__finite::node>(ivy_deser &inp, client_server_ae__node_1_request_1_response_1__finite::node &res){
    int __res;
    __deser(inp,__res);
    res = (client_server_ae__node_1_request_1_response_1__finite::node)__res;
}
template <>
client_server_ae__node_1_request_1_response_1__finite::request _arg<client_server_ae__node_1_request_1_response_1__finite::request>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "request0") return client_server_ae__node_1_request_1_response_1__finite::request0;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<client_server_ae__node_1_request_1_response_1__finite::request>(ivy_deser &inp, client_server_ae__node_1_request_1_response_1__finite::request &res){
    int __res;
    __deser(inp,__res);
    res = (client_server_ae__node_1_request_1_response_1__finite::request)__res;
}
template <>
client_server_ae__node_1_request_1_response_1__finite::response _arg<client_server_ae__node_1_request_1_response_1__finite::response>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "response0") return client_server_ae__node_1_request_1_response_1__finite::response0;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<client_server_ae__node_1_request_1_response_1__finite::response>(ivy_deser &inp, client_server_ae__node_1_request_1_response_1__finite::response &res){
    int __res;
    __deser(inp,__res);
    res = (client_server_ae__node_1_request_1_response_1__finite::response)__res;
}
...
class cmd_reader: public stdin_reader {
    int lineno;
public:
    client_server_ae__node_1_request_1_response_1__finite_repl &ivy;    

    cmd_reader(client_server_ae__node_1_request_1_response_1__finite_repl &_ivy) : ivy(_ivy) {
        lineno = 1;
        if (isatty(fdes()))
        ...
        try {
            ...
            ivy.__lock();
                ...
                if (action == "get_bool_match") {
                    ...
                    __ivy_out  << "= " << ivy.ext__get_bool_match(_arg<client_server_ae__node_1_request_1_response_1__finite::request>(args,0,1),_arg<client_server_ae__node_1_request_1_response_1__finite::response>(args,1,1),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_request_sent") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_request_sent(_arg<client_server_ae__node_1_request_1_response_1__finite::node>(args,0,1),_arg<client_server_ae__node_1_request_1_response_1__finite::request>(args,1,1),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_responseMatched") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_responseMatched(_arg<client_server_ae__node_1_request_1_response_1__finite::node>(args,0,1),_arg<client_server_ae__node_1_request_1_response_1__finite::response>(args,1,1),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_response_received") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_response_received(_arg<client_server_ae__node_1_request_1_response_1__finite::node>(args,0,1),_arg<client_server_ae__node_1_request_1_response_1__finite::response>(args,1,1),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_response_sent") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_response_sent(_arg<client_server_ae__node_1_request_1_response_1__finite::node>(args,0,1),_arg<client_server_ae__node_1_request_1_response_1__finite::response>(args,1,1),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_match") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_match(_arg<client_server_ae__node_1_request_1_response_1__finite::request>(args,0,1),_arg<client_server_ae__node_1_request_1_response_1__finite::response>(args,1,1)) << std::endl;
                }
                else
    
                if (action == "get_request_sent") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_request_sent(_arg<client_server_ae__node_1_request_1_response_1__finite::node>(args,0,1),_arg<client_server_ae__node_1_request_1_response_1__finite::request>(args,1,1)) << std::endl;
                }
                else
    
                if (action == "get_responseMatched") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_responseMatched(_arg<client_server_ae__node_1_request_1_response_1__finite::node>(args,0,1),_arg<client_server_ae__node_1_request_1_response_1__finite::response>(args,1,1)) << std::endl;
                }
                else
    
                if (action == "get_response_received") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_response_received(_arg<client_server_ae__node_1_request_1_response_1__finite::node>(args,0,1),_arg<client_server_ae__node_1_request_1_response_1__finite::response>(args,1,1)) << std::endl;
                }
                else
    
                if (action == "get_response_sent") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_response_sent(_arg<client_server_ae__node_1_request_1_response_1__finite::node>(args,0,1),_arg<client_server_ae__node_1_request_1_response_1__finite::response>(args,1,1)) << std::endl;
                }
                else
    
                if (action == "new_request") {
                    check_arity(args,2,action);
                    ivy.ext__new_request(_arg<client_server_ae__node_1_request_1_response_1__finite::node>(args,0,1),_arg<client_server_ae__node_1_request_1_response_1__finite::request>(args,1,1));
                }
                else
    
                if (action == "receive_response") {
                    check_arity(args,2,action);
                    ivy.ext__receive_response(_arg<client_server_ae__node_1_request_1_response_1__finite::node>(args,0,1),_arg<client_server_ae__node_1_request_1_response_1__finite::response>(args,1,1));
                }
                else
    
                if (action == "respond") {
                    check_arity(args,3,action);
                    ivy.ext__respond(_arg<client_server_ae__node_1_request_1_response_1__finite::node>(args,0,1),_arg<client_server_ae__node_1_request_1_response_1__finite::request>(args,1,1),_arg<client_server_ae__node_1_request_1_response_1__finite::response>(args,2,1));
                }
                else
...
int main(int argc, char **argv){
    ...
    if (argc != 1){
        std::cerr << "usage: client_server_ae__node_1_request_1_response_1__finite \n";
        __ivy_exit(1);
    }
...
#include <vector>
client_server_ae__node_1_request_1_response_1__finite_repl * ivy_exec;
cmd_reader* ivy_exec_cr;
std::ostringstream ivy_exec_stream;

void ivy_exec_init(){
	__ivy_out.basic_ios<char>::rdbuf(ivy_exec_stream.rdbuf());
	ivy_exec = new client_server_ae__node_1_request_1_response_1__finite_repl;
	ivy_exec -> __unlock();
...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[2]) >> ivy_exec -> response_received[0][0];
	std::stringstream(state_values[3]) >> ivy_exec -> response_sent[0][0];
}
