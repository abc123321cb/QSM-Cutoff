...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[2]) >> ivy_exec -> held;
	std::stringstream(state_values[3]) >> ivy_exec -> holds_lock[0];
	std::stringstream(state_values[4]) >> ivy_exec -> holds_lock[1];
	std::stringstream(state_values[5]) >> ivy_exec -> lock_msg[0];
	std::stringstream(state_values[6]) >> ivy_exec -> lock_msg[1];
	std::stringstream(state_values[7]) >> ivy_exec -> unlock_msg[0];
	std::stringstream(state_values[8]) >> ivy_exec -> unlock_msg[1];
}
