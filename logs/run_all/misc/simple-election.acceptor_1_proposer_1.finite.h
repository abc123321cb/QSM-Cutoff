...
class simple_election__acceptor_1_proposer_1__finite {
  public:
    ...
    virtual ~simple_election__acceptor_1_proposer_1__finite();
    ...
    simple_election__acceptor_1_proposer_1__finite();
void __init();
