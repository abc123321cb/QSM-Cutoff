...
class TCommit__resource_manager_3__finite {
  public:
    ...
    virtual ~TCommit__resource_manager_3__finite();
    ...
    enum resource_manager{resource_manager0,resource_manager1,resource_manager2};
    bool working[3];
    bool prepared[3];
    bool committed[3];
    bool aborted[3];
    TCommit__resource_manager_3__finite();
void __init();
    virtual void ext__prepare(resource_manager rm);
    virtual void ext__decide_commit(resource_manager rm);
    virtual void ext__decide_abort(resource_manager rm);
