...
class sharded_kv_no_lost_keys__node_3_key_1_value_2__finite {
  public:
    ...
    virtual ~sharded_kv_no_lost_keys__node_3_key_1_value_2__finite();
    ...
    bool table[3][1][2];
    bool owner[3][1];
    bool transfer_msg[3][1][2];
    sharded_kv_no_lost_keys__node_3_key_1_value_2__finite();
void __init();
