...
class sharded_kv_no_lost_keys__node_2_key_1_value_1__finite {
  public:
    ...
    virtual ~sharded_kv_no_lost_keys__node_2_key_1_value_1__finite();
    ...
    bool table[2][1][1];
    bool owner[2][1];
    bool transfer_msg[2][1][1];
    sharded_kv_no_lost_keys__node_2_key_1_value_1__finite();
void __init();
