...
class client_server_ae__node_2_request_1_response_1__finite {
  public:
    ...
    virtual ~client_server_ae__node_2_request_1_response_1__finite();
    ...
    enum request{request0};
    enum response{response0};
    bool match[1][1];
    bool request_sent[2][1];
    bool response_sent[2][1];
    bool response_received[2][1];
    virtual bool responseMatched(node N, response P);
    client_server_ae__node_2_request_1_response_1__finite();
void __init();
