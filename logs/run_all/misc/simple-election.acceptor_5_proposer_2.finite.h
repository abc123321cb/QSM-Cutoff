...
class simple_election__acceptor_5_proposer_2__finite {
  public:
    ...
    virtual ~simple_election__acceptor_5_proposer_2__finite();
    ...
    simple_election__acceptor_5_proposer_2__finite();
void __init();
