...
class simple_election__acceptor_3_proposer_4__finite {
  public:
    ...
    virtual ~simple_election__acceptor_3_proposer_4__finite();
    ...
    enum acceptor{acceptor0,acceptor1,acceptor2};
    enum quorum{quorum__acceptor0_acceptor1,quorum__acceptor0_acceptor2,quorum__acceptor1_acceptor2};
    ...
    simple_election__acceptor_3_proposer_4__finite();
void __init();
