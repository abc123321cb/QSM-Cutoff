...
class client_server_ae__node_1_request_2_response_1__finite {
  public:
    ...
    virtual ~client_server_ae__node_1_request_2_response_1__finite();
    ...
    bool match[2][1];
    bool request_sent[1][2];
    bool response_sent[1][1];
    bool response_received[1][1];
    virtual bool responseMatched(node N, response P);
    client_server_ae__node_1_request_2_response_1__finite();
void __init();
