#include "naive_consensus.node_1_value_2.finite.h"
...
#include <cstdint>
#endif
typedef naive_consensus__node_1_value_2__finite ivy_class;
...
void naive_consensus__node_1_value_2__finite::install_reader(reader *r) {
    #ifdef _WIN32
...
void naive_consensus__node_1_value_2__finite::install_thread(reader *r) {
    install_reader(r);
}

void naive_consensus__node_1_value_2__finite::install_timer(timer *r) {
    #ifdef _WIN32
...
#ifdef _WIN32
    void naive_consensus__node_1_value_2__finite::__lock() { WaitForSingleObject(mutex,INFINITE); }
    void naive_consensus__node_1_value_2__finite::__unlock() { ReleaseMutex(mutex); }
#else
    void naive_consensus__node_1_value_2__finite::__lock() { pthread_mutex_lock(&mutex); }
    void naive_consensus__node_1_value_2__finite::__unlock() { pthread_mutex_unlock(&mutex); }
#endif
...
std::ostream &operator <<(std::ostream &s, const naive_consensus__node_1_value_2__finite::node &t);
template <>
naive_consensus__node_1_value_2__finite::node _arg<naive_consensus__node_1_value_2__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<naive_consensus__node_1_value_2__finite::node>(ivy_ser &res, const naive_consensus__node_1_value_2__finite::node&);
template <>
void  __deser<naive_consensus__node_1_value_2__finite::node>(ivy_deser &inp, naive_consensus__node_1_value_2__finite::node &res);
std::ostream &operator <<(std::ostream &s, const naive_consensus__node_1_value_2__finite::quorum &t);
template <>
naive_consensus__node_1_value_2__finite::quorum _arg<naive_consensus__node_1_value_2__finite::quorum>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<naive_consensus__node_1_value_2__finite::quorum>(ivy_ser &res, const naive_consensus__node_1_value_2__finite::quorum&);
template <>
void  __deser<naive_consensus__node_1_value_2__finite::quorum>(ivy_deser &inp, naive_consensus__node_1_value_2__finite::quorum &res);
std::ostream &operator <<(std::ostream &s, const naive_consensus__node_1_value_2__finite::value &t);
template <>
naive_consensus__node_1_value_2__finite::value _arg<naive_consensus__node_1_value_2__finite::value>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<naive_consensus__node_1_value_2__finite::value>(ivy_ser &res, const naive_consensus__node_1_value_2__finite::value&);
template <>
void  __deser<naive_consensus__node_1_value_2__finite::value>(ivy_deser &inp, naive_consensus__node_1_value_2__finite::value &res);
int naive_consensus__node_1_value_2__finite::___ivy_choose(int rng,const char *name,int id) {
        return 0;
    }
struct ivy_nondet_except {}; // lauren-yrluo added
void naive_consensus__node_1_value_2__finite::__init(){
...
void naive_consensus__node_1_value_2__finite::ext__cast_vote(node n, value v){
        int __tmp3;
        __tmp3 = 1;
        for (int V = 0; V < 2; V++) {
            if (!!vote[n][V]) __tmp3 = 0;
        }
        ivy_assume(__tmp3, "naive_consensus.node_1_value_2.finite.ivy: line 21");
        vote[n][v] = true;
}
void naive_consensus__node_1_value_2__finite::ext__collect_votes(quorum q, value v){
        int __tmp4;
        __tmp4 = 1;
        for (int N = 0; N < 1; N++) {
            if (!(!member[N][q] || vote[N][v])) __tmp4 = 0;
        }
        ivy_assume(__tmp4, "naive_consensus.node_1_value_2.finite.ivy: line 26");
        decide[q][v] = true;
}
void naive_consensus__node_1_value_2__finite::ext__learn_value(quorum q, value v){
        ivy_assume(decide[q][v], "naive_consensus.node_1_value_2.finite.ivy: line 31");
        decision[v] = true;
}
bool naive_consensus__node_1_value_2__finite::ext__get_decision(value v0){
    bool qrm_result;
    qrm_result = decision[v0];
    return qrm_result;
}
bool naive_consensus__node_1_value_2__finite::ext__get_bool_decision(value v0, bool result){
    bool qrm_result;
    qrm_result = (decision[v0] == result);
    return qrm_result;
}
bool naive_consensus__node_1_value_2__finite::ext__get_vote(node n0, value v1){
    bool qrm_result;
    qrm_result = vote[n0][v1];
    return qrm_result;
}
bool naive_consensus__node_1_value_2__finite::ext__get_bool_vote(node n0, value v1, bool result){
    bool qrm_result;
    qrm_result = (vote[n0][v1] == result);
    return qrm_result;
}
bool naive_consensus__node_1_value_2__finite::ext__get_member(node n0, quorum q1){
    bool qrm_result;
    qrm_result = member[n0][q1];
    return qrm_result;
}
bool naive_consensus__node_1_value_2__finite::ext__get_bool_member(node n0, quorum q1, bool result){
    bool qrm_result;
    qrm_result = (member[n0][q1] == result);
    return qrm_result;
}
bool naive_consensus__node_1_value_2__finite::ext__get_decide(quorum q0, value v1){
    bool qrm_result;
    qrm_result = decide[q0][v1];
    return qrm_result;
}
bool naive_consensus__node_1_value_2__finite::ext__get_bool_decide(quorum q0, value v1, bool result){
    bool qrm_result;
    qrm_result = (decide[q0][v1] == result);
    return qrm_result;
}
void naive_consensus__node_1_value_2__finite::__tick(int __timeout){
}
naive_consensus__node_1_value_2__finite::naive_consensus__node_1_value_2__finite(){
#ifdef _WIN32
...
std::ostream &operator <<(std::ostream &s, const naive_consensus__node_1_value_2__finite::node &t){
    if (t == naive_consensus__node_1_value_2__finite::node0) s<<"node0";
    return s;
}
template <>
void  __ser<naive_consensus__node_1_value_2__finite::node>(ivy_ser &res, const naive_consensus__node_1_value_2__finite::node&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const naive_consensus__node_1_value_2__finite::quorum &t){
    if (t == naive_consensus__node_1_value_2__finite::quorum__node0) s<<"quorum__node0";
    return s;
}
template <>
void  __ser<naive_consensus__node_1_value_2__finite::quorum>(ivy_ser &res, const naive_consensus__node_1_value_2__finite::quorum&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const naive_consensus__node_1_value_2__finite::value &t){
    if (t == naive_consensus__node_1_value_2__finite::value0) s<<"value0";
    if (t == naive_consensus__node_1_value_2__finite::value1) s<<"value1";
    return s;
}
template <>
void  __ser<naive_consensus__node_1_value_2__finite::value>(ivy_ser &res, const naive_consensus__node_1_value_2__finite::value&t){
    __ser(res,(int)t);
}
...
int ask_ret(long long bound) {
    ...
    class naive_consensus__node_1_value_2__finite_repl : public naive_consensus__node_1_value_2__finite {
    ...
    virtual void ivy_assume(bool truth,const char *msg){
        ...
        naive_consensus__node_1_value_2__finite_repl() : naive_consensus__node_1_value_2__finite(){}
...
naive_consensus__node_1_value_2__finite::node _arg<naive_consensus__node_1_value_2__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ...
    if(arg.atom == "node0") return naive_consensus__node_1_value_2__finite::node0;
...
void __deser<naive_consensus__node_1_value_2__finite::node>(ivy_deser &inp, naive_consensus__node_1_value_2__finite::node &res){
    int __res;
    __deser(inp,__res);
    res = (naive_consensus__node_1_value_2__finite::node)__res;
}
template <>
naive_consensus__node_1_value_2__finite::quorum _arg<naive_consensus__node_1_value_2__finite::quorum>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "quorum__node0") return naive_consensus__node_1_value_2__finite::quorum__node0;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<naive_consensus__node_1_value_2__finite::quorum>(ivy_deser &inp, naive_consensus__node_1_value_2__finite::quorum &res){
    int __res;
    __deser(inp,__res);
    res = (naive_consensus__node_1_value_2__finite::quorum)__res;
}
template <>
naive_consensus__node_1_value_2__finite::value _arg<naive_consensus__node_1_value_2__finite::value>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "value0") return naive_consensus__node_1_value_2__finite::value0;
    if(arg.atom == "value1") return naive_consensus__node_1_value_2__finite::value1;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<naive_consensus__node_1_value_2__finite::value>(ivy_deser &inp, naive_consensus__node_1_value_2__finite::value &res){
    int __res;
    __deser(inp,__res);
    res = (naive_consensus__node_1_value_2__finite::value)__res;
}
...
class cmd_reader: public stdin_reader {
    int lineno;
public:
    naive_consensus__node_1_value_2__finite_repl &ivy;    

    cmd_reader(naive_consensus__node_1_value_2__finite_repl &_ivy) : ivy(_ivy) {
        lineno = 1;
        if (isatty(fdes()))
        ...
        try {
            ...
            ivy.__lock();
                ...
                if (action == "cast_vote") {
                    ...
                    ivy.ext__cast_vote(_arg<naive_consensus__node_1_value_2__finite::node>(args,0,1),_arg<naive_consensus__node_1_value_2__finite::value>(args,1,2));
                }
                else
    
                if (action == "collect_votes") {
                    check_arity(args,2,action);
                    ivy.ext__collect_votes(_arg<naive_consensus__node_1_value_2__finite::quorum>(args,0,1),_arg<naive_consensus__node_1_value_2__finite::value>(args,1,2));
                }
                else
    
                if (action == "get_bool_decide") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_decide(_arg<naive_consensus__node_1_value_2__finite::quorum>(args,0,1),_arg<naive_consensus__node_1_value_2__finite::value>(args,1,2),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_decision") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_decision(_arg<naive_consensus__node_1_value_2__finite::value>(args,0,2),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_member") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_member(_arg<naive_consensus__node_1_value_2__finite::node>(args,0,1),_arg<naive_consensus__node_1_value_2__finite::quorum>(args,1,1),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_vote") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_vote(_arg<naive_consensus__node_1_value_2__finite::node>(args,0,1),_arg<naive_consensus__node_1_value_2__finite::value>(args,1,2),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_decide") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_decide(_arg<naive_consensus__node_1_value_2__finite::quorum>(args,0,1),_arg<naive_consensus__node_1_value_2__finite::value>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_decision") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_decision(_arg<naive_consensus__node_1_value_2__finite::value>(args,0,2)) << std::endl;
                }
                else
    
                if (action == "get_member") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_member(_arg<naive_consensus__node_1_value_2__finite::node>(args,0,1),_arg<naive_consensus__node_1_value_2__finite::quorum>(args,1,1)) << std::endl;
                }
                else
    
                if (action == "get_vote") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_vote(_arg<naive_consensus__node_1_value_2__finite::node>(args,0,1),_arg<naive_consensus__node_1_value_2__finite::value>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "learn_value") {
                    check_arity(args,2,action);
                    ivy.ext__learn_value(_arg<naive_consensus__node_1_value_2__finite::quorum>(args,0,1),_arg<naive_consensus__node_1_value_2__finite::value>(args,1,2));
                }
                else
...
int main(int argc, char **argv){
    ...
    if (argc != 1){
        std::cerr << "usage: naive_consensus__node_1_value_2__finite \n";
        __ivy_exit(1);
    }
...
#include <vector>
naive_consensus__node_1_value_2__finite_repl * ivy_exec;
cmd_reader* ivy_exec_cr;
std::ostringstream ivy_exec_stream;

void ivy_exec_init(){
	__ivy_out.basic_ios<char>::rdbuf(ivy_exec_stream.rdbuf());
	ivy_exec = new naive_consensus__node_1_value_2__finite_repl;
	ivy_exec -> __unlock();
