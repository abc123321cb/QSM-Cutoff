...
class simple_election__acceptor_2_proposer_2__finite {
  public:
    ...
    virtual ~simple_election__acceptor_2_proposer_2__finite();
    ...
    enum acceptor{acceptor0,acceptor1};
    enum quorum{quorum__acceptor0_acceptor1};
    ...
    simple_election__acceptor_2_proposer_2__finite();
void __init();
