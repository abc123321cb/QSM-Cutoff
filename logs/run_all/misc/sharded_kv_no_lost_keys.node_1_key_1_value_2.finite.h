...
class sharded_kv_no_lost_keys__node_1_key_1_value_2__finite {
  public:
    ...
    virtual ~sharded_kv_no_lost_keys__node_1_key_1_value_2__finite();
    ...
    bool table[1][1][2];
    bool owner[1][1];
    bool transfer_msg[1][1][2];
    sharded_kv_no_lost_keys__node_1_key_1_value_2__finite();
void __init();
