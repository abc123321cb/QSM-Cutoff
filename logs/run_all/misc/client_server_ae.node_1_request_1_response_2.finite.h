...
class client_server_ae__node_1_request_1_response_2__finite {
  public:
    ...
    virtual ~client_server_ae__node_1_request_1_response_2__finite();
    ...
    bool match[1][2];
    bool request_sent[1][1];
    bool response_sent[1][2];
    bool response_received[1][2];
    virtual bool responseMatched(node N, response P);
    client_server_ae__node_1_request_1_response_2__finite();
void __init();
