#include "toy_consensus.node_3_value_4.finite.h"
...
#include <cstdint>
#endif
typedef toy_consensus__node_3_value_4__finite ivy_class;
...
void toy_consensus__node_3_value_4__finite::install_reader(reader *r) {
    #ifdef _WIN32
...
void toy_consensus__node_3_value_4__finite::install_thread(reader *r) {
    install_reader(r);
}

void toy_consensus__node_3_value_4__finite::install_timer(timer *r) {
    #ifdef _WIN32
...
#ifdef _WIN32
    void toy_consensus__node_3_value_4__finite::__lock() { WaitForSingleObject(mutex,INFINITE); }
    void toy_consensus__node_3_value_4__finite::__unlock() { ReleaseMutex(mutex); }
#else
    void toy_consensus__node_3_value_4__finite::__lock() { pthread_mutex_lock(&mutex); }
    void toy_consensus__node_3_value_4__finite::__unlock() { pthread_mutex_unlock(&mutex); }
#endif
...
std::ostream &operator <<(std::ostream &s, const toy_consensus__node_3_value_4__finite::node &t);
template <>
toy_consensus__node_3_value_4__finite::node _arg<toy_consensus__node_3_value_4__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<toy_consensus__node_3_value_4__finite::node>(ivy_ser &res, const toy_consensus__node_3_value_4__finite::node&);
template <>
void  __deser<toy_consensus__node_3_value_4__finite::node>(ivy_deser &inp, toy_consensus__node_3_value_4__finite::node &res);
std::ostream &operator <<(std::ostream &s, const toy_consensus__node_3_value_4__finite::quorum &t);
template <>
toy_consensus__node_3_value_4__finite::quorum _arg<toy_consensus__node_3_value_4__finite::quorum>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<toy_consensus__node_3_value_4__finite::quorum>(ivy_ser &res, const toy_consensus__node_3_value_4__finite::quorum&);
template <>
void  __deser<toy_consensus__node_3_value_4__finite::quorum>(ivy_deser &inp, toy_consensus__node_3_value_4__finite::quorum &res);
std::ostream &operator <<(std::ostream &s, const toy_consensus__node_3_value_4__finite::value &t);
template <>
toy_consensus__node_3_value_4__finite::value _arg<toy_consensus__node_3_value_4__finite::value>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<toy_consensus__node_3_value_4__finite::value>(ivy_ser &res, const toy_consensus__node_3_value_4__finite::value&);
template <>
void  __deser<toy_consensus__node_3_value_4__finite::value>(ivy_deser &inp, toy_consensus__node_3_value_4__finite::value &res);
int toy_consensus__node_3_value_4__finite::___ivy_choose(int rng,const char *name,int id) {
        return 0;
    }
bool toy_consensus__node_3_value_4__finite::didNotVote(node N){
    bool val;
    int __tmp0;
    __tmp0 = 1;
    for (int V = 0; V < 4; V++) {
...
bool toy_consensus__node_3_value_4__finite::chosenAt(quorum Q, value V){
    bool val;
    int __tmp1;
    __tmp1 = 1;
    for (int N = 0; N < 3; N++) {
...
void toy_consensus__node_3_value_4__finite::__init(){
...
void toy_consensus__node_3_value_4__finite::ext__cast_vote(node n, value v){
        ivy_assume(didNotVote(n), "toy_consensus.node_3_value_4.finite.ivy: line 24");
        vote[n][v] = true;
}
void toy_consensus__node_3_value_4__finite::ext__decide(value v, quorum q){
        ivy_assume(chosenAt(q,v), "toy_consensus.node_3_value_4.finite.ivy: line 29");
        decision[v] = true;
}
bool toy_consensus__node_3_value_4__finite::ext__get_chosenAt(quorum q0, value v1){
    bool qrm_result;
    qrm_result = chosenAt(q0,v1);
    return qrm_result;
}
bool toy_consensus__node_3_value_4__finite::ext__get_bool_chosenAt(quorum q0, value v1, bool result){
    bool qrm_result;
    qrm_result = (chosenAt(q0,v1) == result);
    return qrm_result;
}
bool toy_consensus__node_3_value_4__finite::ext__get_vote(node n0, value v1){
    bool qrm_result;
    qrm_result = vote[n0][v1];
    return qrm_result;
}
bool toy_consensus__node_3_value_4__finite::ext__get_bool_vote(node n0, value v1, bool result){
    bool qrm_result;
    qrm_result = (vote[n0][v1] == result);
    return qrm_result;
}
bool toy_consensus__node_3_value_4__finite::ext__get_member(node n0, quorum q1){
    bool qrm_result;
    qrm_result = member[n0][q1];
    return qrm_result;
}
bool toy_consensus__node_3_value_4__finite::ext__get_bool_member(node n0, quorum q1, bool result){
    bool qrm_result;
    qrm_result = (member[n0][q1] == result);
    return qrm_result;
}
bool toy_consensus__node_3_value_4__finite::ext__get_didNotVote(node n0){
    bool qrm_result;
    qrm_result = didNotVote(n0);
    return qrm_result;
}
bool toy_consensus__node_3_value_4__finite::ext__get_bool_didNotVote(node n0, bool result){
    bool qrm_result;
    qrm_result = (didNotVote(n0) == result);
    return qrm_result;
}
bool toy_consensus__node_3_value_4__finite::ext__get_decision(value v0){
    bool qrm_result;
    qrm_result = decision[v0];
    return qrm_result;
}
bool toy_consensus__node_3_value_4__finite::ext__get_bool_decision(value v0, bool result){
    bool qrm_result;
    qrm_result = (decision[v0] == result);
    return qrm_result;
}
void toy_consensus__node_3_value_4__finite::__tick(int __timeout){
}
toy_consensus__node_3_value_4__finite::toy_consensus__node_3_value_4__finite(){
#ifdef _WIN32
...
std::ostream &operator <<(std::ostream &s, const toy_consensus__node_3_value_4__finite::node &t){
    if (t == toy_consensus__node_3_value_4__finite::node0) s<<"node0";
    if (t == toy_consensus__node_3_value_4__finite::node1) s<<"node1";
    if (t == toy_consensus__node_3_value_4__finite::node2) s<<"node2";
    return s;
}
template <>
void  __ser<toy_consensus__node_3_value_4__finite::node>(ivy_ser &res, const toy_consensus__node_3_value_4__finite::node&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const toy_consensus__node_3_value_4__finite::quorum &t){
    if (t == toy_consensus__node_3_value_4__finite::quorum__node0_node1) s<<"quorum__node0_node1";
    if (t == toy_consensus__node_3_value_4__finite::quorum__node0_node2) s<<"quorum__node0_node2";
    if (t == toy_consensus__node_3_value_4__finite::quorum__node1_node2) s<<"quorum__node1_node2";
    return s;
}
template <>
void  __ser<toy_consensus__node_3_value_4__finite::quorum>(ivy_ser &res, const toy_consensus__node_3_value_4__finite::quorum&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const toy_consensus__node_3_value_4__finite::value &t){
    if (t == toy_consensus__node_3_value_4__finite::value0) s<<"value0";
    if (t == toy_consensus__node_3_value_4__finite::value1) s<<"value1";
    if (t == toy_consensus__node_3_value_4__finite::value2) s<<"value2";
    if (t == toy_consensus__node_3_value_4__finite::value3) s<<"value3";
    return s;
}
template <>
void  __ser<toy_consensus__node_3_value_4__finite::value>(ivy_ser &res, const toy_consensus__node_3_value_4__finite::value&t){
    __ser(res,(int)t);
}
...
int ask_ret(long long bound) {
    ...
    class toy_consensus__node_3_value_4__finite_repl : public toy_consensus__node_3_value_4__finite {
    ...
    virtual void ivy_assume(bool truth,const char *msg){
        ...
        toy_consensus__node_3_value_4__finite_repl() : toy_consensus__node_3_value_4__finite(){}
...
toy_consensus__node_3_value_4__finite::node _arg<toy_consensus__node_3_value_4__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ...
    if(arg.atom == "node0") return toy_consensus__node_3_value_4__finite::node0;
    if(arg.atom == "node1") return toy_consensus__node_3_value_4__finite::node1;
    if(arg.atom == "node2") return toy_consensus__node_3_value_4__finite::node2;
...
void __deser<toy_consensus__node_3_value_4__finite::node>(ivy_deser &inp, toy_consensus__node_3_value_4__finite::node &res){
    int __res;
    __deser(inp,__res);
    res = (toy_consensus__node_3_value_4__finite::node)__res;
}
template <>
toy_consensus__node_3_value_4__finite::quorum _arg<toy_consensus__node_3_value_4__finite::quorum>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "quorum__node0_node1") return toy_consensus__node_3_value_4__finite::quorum__node0_node1;
    if(arg.atom == "quorum__node0_node2") return toy_consensus__node_3_value_4__finite::quorum__node0_node2;
    if(arg.atom == "quorum__node1_node2") return toy_consensus__node_3_value_4__finite::quorum__node1_node2;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<toy_consensus__node_3_value_4__finite::quorum>(ivy_deser &inp, toy_consensus__node_3_value_4__finite::quorum &res){
    int __res;
    __deser(inp,__res);
    res = (toy_consensus__node_3_value_4__finite::quorum)__res;
}
template <>
toy_consensus__node_3_value_4__finite::value _arg<toy_consensus__node_3_value_4__finite::value>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "value0") return toy_consensus__node_3_value_4__finite::value0;
    if(arg.atom == "value1") return toy_consensus__node_3_value_4__finite::value1;
    if(arg.atom == "value2") return toy_consensus__node_3_value_4__finite::value2;
    if(arg.atom == "value3") return toy_consensus__node_3_value_4__finite::value3;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<toy_consensus__node_3_value_4__finite::value>(ivy_deser &inp, toy_consensus__node_3_value_4__finite::value &res){
    int __res;
    __deser(inp,__res);
    res = (toy_consensus__node_3_value_4__finite::value)__res;
}
...
class cmd_reader: public stdin_reader {
    int lineno;
public:
    toy_consensus__node_3_value_4__finite_repl &ivy;    

    cmd_reader(toy_consensus__node_3_value_4__finite_repl &_ivy) : ivy(_ivy) {
        lineno = 1;
        if (isatty(fdes()))
        ...
        try {
            ...
            ivy.__lock();
                ...
                if (action == "cast_vote") {
                    ...
                    ivy.ext__cast_vote(_arg<toy_consensus__node_3_value_4__finite::node>(args,0,3),_arg<toy_consensus__node_3_value_4__finite::value>(args,1,4));
                }
                else
    
                if (action == "decide") {
                    check_arity(args,2,action);
                    ivy.ext__decide(_arg<toy_consensus__node_3_value_4__finite::value>(args,0,4),_arg<toy_consensus__node_3_value_4__finite::quorum>(args,1,3));
                }
                else
    
                if (action == "get_bool_chosenAt") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_chosenAt(_arg<toy_consensus__node_3_value_4__finite::quorum>(args,0,3),_arg<toy_consensus__node_3_value_4__finite::value>(args,1,4),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_decision") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_decision(_arg<toy_consensus__node_3_value_4__finite::value>(args,0,4),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_didNotVote") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_didNotVote(_arg<toy_consensus__node_3_value_4__finite::node>(args,0,3),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_member") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_member(_arg<toy_consensus__node_3_value_4__finite::node>(args,0,3),_arg<toy_consensus__node_3_value_4__finite::quorum>(args,1,3),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_vote") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_vote(_arg<toy_consensus__node_3_value_4__finite::node>(args,0,3),_arg<toy_consensus__node_3_value_4__finite::value>(args,1,4),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_chosenAt") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_chosenAt(_arg<toy_consensus__node_3_value_4__finite::quorum>(args,0,3),_arg<toy_consensus__node_3_value_4__finite::value>(args,1,4)) << std::endl;
                }
                else
    
                if (action == "get_decision") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_decision(_arg<toy_consensus__node_3_value_4__finite::value>(args,0,4)) << std::endl;
                }
                else
    
                if (action == "get_didNotVote") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_didNotVote(_arg<toy_consensus__node_3_value_4__finite::node>(args,0,3)) << std::endl;
                }
                else
    
                if (action == "get_member") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_member(_arg<toy_consensus__node_3_value_4__finite::node>(args,0,3),_arg<toy_consensus__node_3_value_4__finite::quorum>(args,1,3)) << std::endl;
                }
                else
    
                if (action == "get_vote") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_vote(_arg<toy_consensus__node_3_value_4__finite::node>(args,0,3),_arg<toy_consensus__node_3_value_4__finite::value>(args,1,4)) << std::endl;
                }
                else
...
int main(int argc, char **argv){
    ...
    if (argc != 1){
        std::cerr << "usage: toy_consensus__node_3_value_4__finite \n";
        __ivy_exit(1);
    }
