...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[2]) >> ivy_exec -> holds[2];
	std::stringstream(state_values[3]) >> ivy_exec -> replied[0][0];
	std::stringstream(state_values[4]) >> ivy_exec -> replied[0][1];
	std::stringstream(state_values[5]) >> ivy_exec -> replied[0][2];
	std::stringstream(state_values[6]) >> ivy_exec -> replied[1][0];
	std::stringstream(state_values[7]) >> ivy_exec -> replied[1][1];
	std::stringstream(state_values[8]) >> ivy_exec -> replied[1][2];
	std::stringstream(state_values[9]) >> ivy_exec -> replied[2][0];
	std::stringstream(state_values[10]) >> ivy_exec -> replied[2][1];
	std::stringstream(state_values[11]) >> ivy_exec -> replied[2][2];
