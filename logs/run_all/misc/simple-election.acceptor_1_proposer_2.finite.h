...
class simple_election__acceptor_1_proposer_2__finite {
  public:
    ...
    virtual ~simple_election__acceptor_1_proposer_2__finite();
    ...
    enum acceptor{acceptor0};
    enum quorum{quorum__acceptor0};
    ...
    simple_election__acceptor_1_proposer_2__finite();
void __init();
