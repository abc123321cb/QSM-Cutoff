#include "simple-election.acceptor_1_proposer_1.finite.h"
...
#include <cstdint>
#endif
typedef simple_election__acceptor_1_proposer_1__finite ivy_class;
...
void simple_election__acceptor_1_proposer_1__finite::install_reader(reader *r) {
    #ifdef _WIN32
...
void simple_election__acceptor_1_proposer_1__finite::install_thread(reader *r) {
    install_reader(r);
}

void simple_election__acceptor_1_proposer_1__finite::install_timer(timer *r) {
    #ifdef _WIN32
...
#ifdef _WIN32
    void simple_election__acceptor_1_proposer_1__finite::__lock() { WaitForSingleObject(mutex,INFINITE); }
    void simple_election__acceptor_1_proposer_1__finite::__unlock() { ReleaseMutex(mutex); }
#else
    void simple_election__acceptor_1_proposer_1__finite::__lock() { pthread_mutex_lock(&mutex); }
    void simple_election__acceptor_1_proposer_1__finite::__unlock() { pthread_mutex_unlock(&mutex); }
#endif
...
std::ostream &operator <<(std::ostream &s, const simple_election__acceptor_1_proposer_1__finite::acceptor &t);
template <>
simple_election__acceptor_1_proposer_1__finite::acceptor _arg<simple_election__acceptor_1_proposer_1__finite::acceptor>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<simple_election__acceptor_1_proposer_1__finite::acceptor>(ivy_ser &res, const simple_election__acceptor_1_proposer_1__finite::acceptor&);
template <>
void  __deser<simple_election__acceptor_1_proposer_1__finite::acceptor>(ivy_deser &inp, simple_election__acceptor_1_proposer_1__finite::acceptor &res);
std::ostream &operator <<(std::ostream &s, const simple_election__acceptor_1_proposer_1__finite::proposer &t);
template <>
simple_election__acceptor_1_proposer_1__finite::proposer _arg<simple_election__acceptor_1_proposer_1__finite::proposer>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<simple_election__acceptor_1_proposer_1__finite::proposer>(ivy_ser &res, const simple_election__acceptor_1_proposer_1__finite::proposer&);
template <>
void  __deser<simple_election__acceptor_1_proposer_1__finite::proposer>(ivy_deser &inp, simple_election__acceptor_1_proposer_1__finite::proposer &res);
std::ostream &operator <<(std::ostream &s, const simple_election__acceptor_1_proposer_1__finite::quorum &t);
template <>
simple_election__acceptor_1_proposer_1__finite::quorum _arg<simple_election__acceptor_1_proposer_1__finite::quorum>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<simple_election__acceptor_1_proposer_1__finite::quorum>(ivy_ser &res, const simple_election__acceptor_1_proposer_1__finite::quorum&);
template <>
void  __deser<simple_election__acceptor_1_proposer_1__finite::quorum>(ivy_deser &inp, simple_election__acceptor_1_proposer_1__finite::quorum &res);
int simple_election__acceptor_1_proposer_1__finite::___ivy_choose(int rng,const char *name,int id) {
        return 0;
    }
bool simple_election__acceptor_1_proposer_1__finite::didNotPromise(acceptor A){
    bool val;
    int __tmp0;
    __tmp0 = 1;
    for (int P = 0; P < 1; P++) {
...
bool simple_election__acceptor_1_proposer_1__finite::chosenAt(quorum Q, proposer P){
    bool val;
    int __tmp1;
    __tmp1 = 1;
    for (int A = 0; A < 1; A++) {
...
void simple_election__acceptor_1_proposer_1__finite::__init(){
...
void simple_election__acceptor_1_proposer_1__finite::ext__send_1a(proposer p){
    start[p] = true;
}
void simple_election__acceptor_1_proposer_1__finite::ext__send_1b(acceptor a, proposer p){
        ivy_assume(start[p], "simple-election.acceptor_1_proposer_1.finite.ivy: line 43");
        ivy_assume(didNotPromise(a), "simple-election.acceptor_1_proposer_1.finite.ivy: line 44");
        promise[a][p] = true;
}
void simple_election__acceptor_1_proposer_1__finite::ext__decide(proposer p, quorum q){
        ivy_assume(chosenAt(q,p), "simple-election.acceptor_1_proposer_1.finite.ivy: line 49");
        leader[p] = true;
}
bool simple_election__acceptor_1_proposer_1__finite::ext__get_chosenAt(quorum q0, proposer p1){
    bool qrm_result;
    qrm_result = chosenAt(q0,p1);
    return qrm_result;
}
bool simple_election__acceptor_1_proposer_1__finite::ext__get_bool_chosenAt(quorum q0, proposer p1, bool result){
    bool qrm_result;
    qrm_result = (chosenAt(q0,p1) == result);
    return qrm_result;
}
bool simple_election__acceptor_1_proposer_1__finite::ext__get_start(proposer p0){
    bool qrm_result;
    qrm_result = start[p0];
    return qrm_result;
}
bool simple_election__acceptor_1_proposer_1__finite::ext__get_bool_start(proposer p0, bool result){
    bool qrm_result;
    qrm_result = (start[p0] == result);
    return qrm_result;
}
bool simple_election__acceptor_1_proposer_1__finite::ext__get_leader(proposer p0){
    bool qrm_result;
    qrm_result = leader[p0];
    return qrm_result;
}
bool simple_election__acceptor_1_proposer_1__finite::ext__get_bool_leader(proposer p0, bool result){
    bool qrm_result;
    qrm_result = (leader[p0] == result);
    return qrm_result;
}
bool simple_election__acceptor_1_proposer_1__finite::ext__get_promise(acceptor a0, proposer p1){
    bool qrm_result;
    qrm_result = promise[a0][p1];
    return qrm_result;
}
bool simple_election__acceptor_1_proposer_1__finite::ext__get_bool_promise(acceptor a0, proposer p1, bool result){
    bool qrm_result;
    qrm_result = (promise[a0][p1] == result);
    return qrm_result;
}
bool simple_election__acceptor_1_proposer_1__finite::ext__get_member(acceptor a0, quorum q1){
    bool qrm_result;
    qrm_result = member[a0][q1];
    return qrm_result;
}
bool simple_election__acceptor_1_proposer_1__finite::ext__get_bool_member(acceptor a0, quorum q1, bool result){
    bool qrm_result;
    qrm_result = (member[a0][q1] == result);
    return qrm_result;
}
bool simple_election__acceptor_1_proposer_1__finite::ext__get_didNotPromise(acceptor a0){
    bool qrm_result;
    qrm_result = didNotPromise(a0);
    return qrm_result;
}
bool simple_election__acceptor_1_proposer_1__finite::ext__get_bool_didNotPromise(acceptor a0, bool result){
    bool qrm_result;
    qrm_result = (didNotPromise(a0) == result);
    return qrm_result;
}
void simple_election__acceptor_1_proposer_1__finite::__tick(int __timeout){
}
simple_election__acceptor_1_proposer_1__finite::simple_election__acceptor_1_proposer_1__finite(){
#ifdef _WIN32
...
std::ostream &operator <<(std::ostream &s, const simple_election__acceptor_1_proposer_1__finite::acceptor &t){
    if (t == simple_election__acceptor_1_proposer_1__finite::acceptor0) s<<"acceptor0";
    return s;
}
template <>
void  __ser<simple_election__acceptor_1_proposer_1__finite::acceptor>(ivy_ser &res, const simple_election__acceptor_1_proposer_1__finite::acceptor&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const simple_election__acceptor_1_proposer_1__finite::proposer &t){
    if (t == simple_election__acceptor_1_proposer_1__finite::proposer0) s<<"proposer0";
    return s;
}
template <>
void  __ser<simple_election__acceptor_1_proposer_1__finite::proposer>(ivy_ser &res, const simple_election__acceptor_1_proposer_1__finite::proposer&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const simple_election__acceptor_1_proposer_1__finite::quorum &t){
    if (t == simple_election__acceptor_1_proposer_1__finite::quorum__acceptor0) s<<"quorum__acceptor0";
    return s;
}
template <>
void  __ser<simple_election__acceptor_1_proposer_1__finite::quorum>(ivy_ser &res, const simple_election__acceptor_1_proposer_1__finite::quorum&t){
    __ser(res,(int)t);
}
...
int ask_ret(long long bound) {
    ...
    class simple_election__acceptor_1_proposer_1__finite_repl : public simple_election__acceptor_1_proposer_1__finite {
    ...
    virtual void ivy_assume(bool truth,const char *msg){
        ...
        simple_election__acceptor_1_proposer_1__finite_repl() : simple_election__acceptor_1_proposer_1__finite(){}
...
simple_election__acceptor_1_proposer_1__finite::acceptor _arg<simple_election__acceptor_1_proposer_1__finite::acceptor>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ...
    if(arg.atom == "acceptor0") return simple_election__acceptor_1_proposer_1__finite::acceptor0;
...
void __deser<simple_election__acceptor_1_proposer_1__finite::acceptor>(ivy_deser &inp, simple_election__acceptor_1_proposer_1__finite::acceptor &res){
    int __res;
    __deser(inp,__res);
    res = (simple_election__acceptor_1_proposer_1__finite::acceptor)__res;
}
template <>
simple_election__acceptor_1_proposer_1__finite::proposer _arg<simple_election__acceptor_1_proposer_1__finite::proposer>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "proposer0") return simple_election__acceptor_1_proposer_1__finite::proposer0;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<simple_election__acceptor_1_proposer_1__finite::proposer>(ivy_deser &inp, simple_election__acceptor_1_proposer_1__finite::proposer &res){
    int __res;
    __deser(inp,__res);
    res = (simple_election__acceptor_1_proposer_1__finite::proposer)__res;
}
template <>
simple_election__acceptor_1_proposer_1__finite::quorum _arg<simple_election__acceptor_1_proposer_1__finite::quorum>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "quorum__acceptor0") return simple_election__acceptor_1_proposer_1__finite::quorum__acceptor0;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<simple_election__acceptor_1_proposer_1__finite::quorum>(ivy_deser &inp, simple_election__acceptor_1_proposer_1__finite::quorum &res){
    int __res;
    __deser(inp,__res);
    res = (simple_election__acceptor_1_proposer_1__finite::quorum)__res;
}
...
class cmd_reader: public stdin_reader {
    int lineno;
public:
    simple_election__acceptor_1_proposer_1__finite_repl &ivy;    

    cmd_reader(simple_election__acceptor_1_proposer_1__finite_repl &_ivy) : ivy(_ivy) {
        lineno = 1;
        if (isatty(fdes()))
        ...
        try {
            ...
            ivy.__lock();
                ...
                if (action == "decide") {
                    ...
                    ivy.ext__decide(_arg<simple_election__acceptor_1_proposer_1__finite::proposer>(args,0,1),_arg<simple_election__acceptor_1_proposer_1__finite::quorum>(args,1,1));
                }
                else
    
                if (action == "get_bool_chosenAt") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_chosenAt(_arg<simple_election__acceptor_1_proposer_1__finite::quorum>(args,0,1),_arg<simple_election__acceptor_1_proposer_1__finite::proposer>(args,1,1),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_didNotPromise") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_didNotPromise(_arg<simple_election__acceptor_1_proposer_1__finite::acceptor>(args,0,1),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_leader") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_leader(_arg<simple_election__acceptor_1_proposer_1__finite::proposer>(args,0,1),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_member") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_member(_arg<simple_election__acceptor_1_proposer_1__finite::acceptor>(args,0,1),_arg<simple_election__acceptor_1_proposer_1__finite::quorum>(args,1,1),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_promise") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_promise(_arg<simple_election__acceptor_1_proposer_1__finite::acceptor>(args,0,1),_arg<simple_election__acceptor_1_proposer_1__finite::proposer>(args,1,1),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_start") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_start(_arg<simple_election__acceptor_1_proposer_1__finite::proposer>(args,0,1),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_chosenAt") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_chosenAt(_arg<simple_election__acceptor_1_proposer_1__finite::quorum>(args,0,1),_arg<simple_election__acceptor_1_proposer_1__finite::proposer>(args,1,1)) << std::endl;
                }
                else
    
                if (action == "get_didNotPromise") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_didNotPromise(_arg<simple_election__acceptor_1_proposer_1__finite::acceptor>(args,0,1)) << std::endl;
                }
                else
    
                if (action == "get_leader") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_leader(_arg<simple_election__acceptor_1_proposer_1__finite::proposer>(args,0,1)) << std::endl;
                }
                else
    
                if (action == "get_member") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_member(_arg<simple_election__acceptor_1_proposer_1__finite::acceptor>(args,0,1),_arg<simple_election__acceptor_1_proposer_1__finite::quorum>(args,1,1)) << std::endl;
                }
                else
    
                if (action == "get_promise") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_promise(_arg<simple_election__acceptor_1_proposer_1__finite::acceptor>(args,0,1),_arg<simple_election__acceptor_1_proposer_1__finite::proposer>(args,1,1)) << std::endl;
                }
                else
    
                if (action == "get_start") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_start(_arg<simple_election__acceptor_1_proposer_1__finite::proposer>(args,0,1)) << std::endl;
                }
                else
    
                if (action == "send_1a") {
                    check_arity(args,1,action);
                    ivy.ext__send_1a(_arg<simple_election__acceptor_1_proposer_1__finite::proposer>(args,0,1));
                }
                else
    
                if (action == "send_1b") {
                    check_arity(args,2,action);
                    ivy.ext__send_1b(_arg<simple_election__acceptor_1_proposer_1__finite::acceptor>(args,0,1),_arg<simple_election__acceptor_1_proposer_1__finite::proposer>(args,1,1));
                }
                else
...
int main(int argc, char **argv){
    ...
    if (argc != 1){
        std::cerr << "usage: simple_election__acceptor_1_proposer_1__finite \n";
        __ivy_exit(1);
    }
...
#include <vector>
simple_election__acceptor_1_proposer_1__finite_repl * ivy_exec;
cmd_reader* ivy_exec_cr;
std::ostringstream ivy_exec_stream;

void ivy_exec_init(){
	__ivy_out.basic_ios<char>::rdbuf(ivy_exec_stream.rdbuf());
	ivy_exec = new simple_election__acceptor_1_proposer_1__finite_repl;
	ivy_exec -> __unlock();
...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[2]) >> ivy_exec -> start[0];
}
