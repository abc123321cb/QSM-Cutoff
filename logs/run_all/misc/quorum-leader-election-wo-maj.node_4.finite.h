...
class quorum_leader_election_wo_maj__node_4__finite {
  public:
    ...
    virtual ~quorum_leader_election_wo_maj__node_4__finite();
    ...
    enum nset{nset__node0_node1_node2,nset__node0_node1_node3,nset__node0_node2_node3,nset__node1_node2_node3};
    bool isleader[4];
    bool voted[4][4];
    bool member[4][4];
    nset quorum;
    quorum_leader_election_wo_maj__node_4__finite();
void __init();
