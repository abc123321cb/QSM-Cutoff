...
class simple_election__acceptor_3_proposer_2__finite {
  public:
    ...
    virtual ~simple_election__acceptor_3_proposer_2__finite();
    ...
    simple_election__acceptor_3_proposer_2__finite();
void __init();
