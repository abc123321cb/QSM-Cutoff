...
class simple_election__acceptor_4_proposer_2__finite {
  public:
    ...
    virtual ~simple_election__acceptor_4_proposer_2__finite();
    ...
    enum proposer{proposer0,proposer1};
    bool member[4][4];
    bool start[2];
    bool promise[4][2];
    bool leader[2];
    ...
    simple_election__acceptor_4_proposer_2__finite();
void __init();
