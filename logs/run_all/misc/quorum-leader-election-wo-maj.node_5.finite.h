...
class quorum_leader_election_wo_maj__node_5__finite {
  public:
    ...
    virtual ~quorum_leader_election_wo_maj__node_5__finite();
    ...
    enum nset{nset__node0_node1_node2,nset__node0_node1_node3,nset__node0_node1_node4,nset__node0_node2_node3,nset__node0_node2_node4,nset__node0_node3_node4,nset__node1_node2_node3,nset__node1_node2_node4,nset__node1_node3_node4,nset__node2_node3_node4};
    bool isleader[5];
    bool voted[5][5];
    bool member[5][10];
    nset quorum;
    quorum_leader_election_wo_maj__node_5__finite();
void __init();
