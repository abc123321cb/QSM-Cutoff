...
simple_decentralized_lock__node_4__finite::node simple_decentralized_lock__node_4__finite::ext__get_start_node(){
    simple_decentralized_lock__node_4__finite::node qrm_result;
...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[4]) >> ivy_exec -> message[0][0];
	std::stringstream(state_values[5]) >> ivy_exec -> message[0][1];
	std::stringstream(state_values[6]) >> ivy_exec -> message[0][2];
	std::stringstream(state_values[7]) >> ivy_exec -> message[0][3];
	std::stringstream(state_values[8]) >> ivy_exec -> message[1][0];
	std::stringstream(state_values[9]) >> ivy_exec -> message[1][1];
	std::stringstream(state_values[10]) >> ivy_exec -> message[1][2];
	std::stringstream(state_values[11]) >> ivy_exec -> message[1][3];
	std::stringstream(state_values[12]) >> ivy_exec -> message[2][0];
	std::stringstream(state_values[13]) >> ivy_exec -> message[2][1];
	std::stringstream(state_values[14]) >> ivy_exec -> message[2][2];
	std::stringstream(state_values[15]) >> ivy_exec -> message[2][3];
	std::stringstream(state_values[16]) >> ivy_exec -> message[3][0];
	std::stringstream(state_values[17]) >> ivy_exec -> message[3][1];
	std::stringstream(state_values[18]) >> ivy_exec -> message[3][2];
	std::stringstream(state_values[19]) >> ivy_exec -> message[3][3];
	{
		ivy_value arg; arg.pos = 0; arg.atom = state_values[20];
