...
class TwoPhase__resource_manager_2__finite {
  public:
    ...
    virtual ~TwoPhase__resource_manager_2__finite();
    ...
    enum resource_manager{resource_manager0,resource_manager1};
    bool working[2];
    bool prepared[2];
    bool committed[2];
    bool aborted[2];
    ...
    bool msg_commit;
    bool msg_abort;
    TwoPhase__resource_manager_2__finite();
void __init();
    virtual void ext__tMRcvPrepared(resource_manager rm);
    virtual void ext__tMCommit();
    virtual void ext__tMAbort();
    virtual void ext__rMPrepare(resource_manager rm);
    virtual void ext__rMChooseToAbort(resource_manager rm);
    virtual void ext__rMRcvCommitMsg(resource_manager rm);
    virtual void ext__rMRcvAbortMsg(resource_manager rm);
    virtual bool ext__get_msg_commit();
    virtual bool ext__get_bool_msg_commit(bool result);
    virtual bool ext__get_tm_aborted();
    virtual bool ext__get_bool_tm_aborted(bool result);
    virtual bool ext__get_working(resource_manager r0);
    virtual bool ext__get_bool_working(resource_manager r0, bool result);
    virtual bool ext__get_prepared(resource_manager r0);
    virtual bool ext__get_bool_prepared(resource_manager r0, bool result);
    virtual bool ext__get_tm_init();
    virtual bool ext__get_bool_tm_init(bool result);
    virtual bool ext__get_aborted(resource_manager r0);
    virtual bool ext__get_bool_aborted(resource_manager r0, bool result);
    virtual bool ext__get_tm_committed();
    virtual bool ext__get_bool_tm_committed(bool result);
    virtual bool ext__get_msg_prepared(resource_manager r0);
    virtual bool ext__get_bool_msg_prepared(resource_manager r0, bool result);
    virtual bool ext__get_msg_abort();
    virtual bool ext__get_bool_msg_abort(bool result);
    virtual bool ext__get_committed(resource_manager r0);
    virtual bool ext__get_bool_committed(resource_manager r0, bool result);
    virtual bool ext__get_tm_prepared(resource_manager r0);
    virtual bool ext__get_bool_tm_prepared(resource_manager r0, bool result);
