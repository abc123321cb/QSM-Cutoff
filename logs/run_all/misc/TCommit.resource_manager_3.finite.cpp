...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[2]) >> ivy_exec -> aborted[2];
	std::stringstream(state_values[3]) >> ivy_exec -> committed[0];
	std::stringstream(state_values[4]) >> ivy_exec -> committed[1];
	std::stringstream(state_values[5]) >> ivy_exec -> committed[2];
	std::stringstream(state_values[6]) >> ivy_exec -> prepared[0];
	std::stringstream(state_values[7]) >> ivy_exec -> prepared[1];
	std::stringstream(state_values[8]) >> ivy_exec -> prepared[2];
	std::stringstream(state_values[9]) >> ivy_exec -> working[0];
	std::stringstream(state_values[10]) >> ivy_exec -> working[1];
	std::stringstream(state_values[11]) >> ivy_exec -> working[2];
}
