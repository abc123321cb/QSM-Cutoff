...
class client_server_ae__node_1_request_1_response_1__finite {
  public:
    ...
    virtual ~client_server_ae__node_1_request_1_response_1__finite();
    ...
    client_server_ae__node_1_request_1_response_1__finite();
void __init();
