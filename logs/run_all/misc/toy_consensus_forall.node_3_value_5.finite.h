...
class toy_consensus_forall__node_3_value_5__finite {
  public:
    ...
    virtual ~toy_consensus_forall__node_3_value_5__finite();
    ...
    enum value{value0,value1,value2,value3,value4};
    bool member[3][3];
    bool voted[3];
    bool vote[3][5];
    bool decided[5];
    quorum voting_quorum;
    toy_consensus_forall__node_3_value_5__finite();
void __init();
