...
class client_server_ae__node_2_request_2_response_2__finite {
  public:
    ...
    virtual ~client_server_ae__node_2_request_2_response_2__finite();
    ...
    enum node{node0,node1};
    enum request{request0,request1};
    enum response{response0,response1};
    bool match[2][2];
    bool request_sent[2][2];
    bool response_sent[2][2];
    bool response_received[2][2];
    virtual bool responseMatched(node N, response P);
    client_server_ae__node_2_request_2_response_2__finite();
void __init();
    virtual void ext__new_request(node n, request r);
    virtual void ext__respond(node n, request r, response p);
    virtual void ext__receive_response(node n, response p);
    virtual bool ext__get_response_received(node n0, response r1);
    virtual bool ext__get_bool_response_received(node n0, response r1, bool result);
    virtual bool ext__get_request_sent(node n0, request r1);
    virtual bool ext__get_bool_request_sent(node n0, request r1, bool result);
    virtual bool ext__get_responseMatched(node n0, response r1);
    virtual bool ext__get_bool_responseMatched(node n0, response r1, bool result);
    virtual bool ext__get_response_sent(node n0, response r1);
    virtual bool ext__get_bool_response_sent(node n0, response r1, bool result);
    virtual bool ext__get_match(request r0, response r1);
    virtual bool ext__get_bool_match(request r0, response r1, bool result);
