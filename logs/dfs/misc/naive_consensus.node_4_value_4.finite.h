...
class naive_consensus__node_4_value_4__finite {
  public:
    ...
    virtual ~naive_consensus__node_4_value_4__finite();
    ...
    bool decide[4][4];
    bool decision[4];
    naive_consensus__node_4_value_4__finite();
void __init();
    virtual void ext__cast_vote(node n, value v);
    virtual void ext__collect_votes(quorum q, value v);
    virtual void ext__learn_value(quorum q, value v);
    virtual bool ext__get_decision(value v0);
    virtual bool ext__get_bool_decision(value v0, bool result);
    virtual bool ext__get_decide(quorum q0, value v1);
    virtual bool ext__get_bool_decide(quorum q0, value v1, bool result);
