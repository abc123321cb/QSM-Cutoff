...
void ivy_exec_set_state(std::vector<std::string> state_values){
	std::stringstream(state_values[0]) >> ivy_exec -> link[0][0];
	std::stringstream(state_values[1]) >> ivy_exec -> link[0][1];
	std::stringstream(state_values[2]) >> ivy_exec -> link[1][0];
	std::stringstream(state_values[3]) >> ivy_exec -> link[1][1];
	std::stringstream(state_values[4]) >> ivy_exec -> link[2][0];
	std::stringstream(state_values[5]) >> ivy_exec -> link[2][1];
	std::stringstream(state_values[6]) >> ivy_exec -> link[3][0];
	std::stringstream(state_values[7]) >> ivy_exec -> link[3][1];
	std::stringstream(state_values[8]) >> ivy_exec -> semaphore[0];
	std::stringstream(state_values[9]) >> ivy_exec -> semaphore[1];
}
