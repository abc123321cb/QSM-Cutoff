...
class toy_consensus__node_4_value_4__finite {
  public:
    ...
    virtual ~toy_consensus__node_4_value_4__finite();
    ...
    enum quorum{quorum__node0_node1_node2,quorum__node0_node1_node3,quorum__node0_node2_node3,quorum__node1_node2_node3};
    bool member[4][4];
    bool vote[4][4];
    bool decision[4];
    virtual bool didNotVote(node N);
    virtual bool chosenAt(quorum Q, value V);
    toy_consensus__node_4_value_4__finite();
void __init();
    ...
    virtual bool ext__get_chosenAt(quorum q0, value v1);
    virtual bool ext__get_bool_chosenAt(quorum q0, value v1, bool result);
    virtual bool ext__get_didNotVote(node n0);
    virtual bool ext__get_bool_didNotVote(node n0, bool result);
    virtual bool ext__get_decision(value v0);
    virtual bool ext__get_bool_decision(value v0, bool result);
