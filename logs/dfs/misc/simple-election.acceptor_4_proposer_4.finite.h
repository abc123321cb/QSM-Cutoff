...
class simple_election__acceptor_4_proposer_4__finite {
  public:
    ...
    virtual ~simple_election__acceptor_4_proposer_4__finite();
    ...
    enum acceptor{acceptor0,acceptor1,acceptor2,acceptor3};
    enum quorum{quorum__acceptor0_acceptor1_acceptor2,quorum__acceptor0_acceptor1_acceptor3,quorum__acceptor0_acceptor2_acceptor3,quorum__acceptor1_acceptor2_acceptor3};
    enum proposer{proposer0,proposer1,proposer2,proposer3};
    bool member[4][4];
    bool start[4];
    bool promise[4][4];
    bool leader[4];
    virtual bool didNotPromise(acceptor A);
    virtual bool chosenAt(quorum Q, proposer P);
    simple_election__acceptor_4_proposer_4__finite();
void __init();
    virtual void ext__send_1a(proposer p);
    virtual void ext__send_1b(acceptor a, proposer p);
    virtual void ext__decide(proposer p, quorum q);
    virtual bool ext__get_promise(acceptor a0, proposer p1);
    virtual bool ext__get_bool_promise(acceptor a0, proposer p1, bool result);
    virtual bool ext__get_leader(proposer p0);
    virtual bool ext__get_bool_leader(proposer p0, bool result);
    virtual bool ext__get_start(proposer p0);
    virtual bool ext__get_bool_start(proposer p0, bool result);
    virtual bool ext__get_chosenAt(quorum q0, proposer p1);
    virtual bool ext__get_bool_chosenAt(quorum q0, proposer p1, bool result);
    virtual bool ext__get_didNotPromise(acceptor a0);
    virtual bool ext__get_bool_didNotPromise(acceptor a0, bool result);
    virtual bool ext__get_member(acceptor a0, quorum q1);
    virtual bool ext__get_bool_member(acceptor a0, quorum q1, bool result);
