...
timeout ${Timeout} python3 run_all.py ${sym_quorum_path}toy_consensus.ivy                 -s node=1,value=1        -i node       -k -v 5 -w -l ${sym_quorum_path}toy_consensus.log
timeout ${Timeout} python3 run_all.py ${sym_quorum_path}toy_consensus_epr.ivy             -s node=1,value=1        -i node       -k -v 5 -w -l ${sym_quorum_path}toy_consensus_epr.log 
timeout ${Timeout} python3 run_all.py ${sym_quorum_path}naive_consensus.ivy               -s node=1,value=1        -i node       -k -v 5 -w -l ${sym_quorum_path}naive_consensus.log 
timeout ${Timeout} python3 run_all.py ${sym_quorum_path}toy_consensus_forall.ivy          -s node=1,value=1        -i node       -k -v 5 -w -l ${sym_quorum_path}toy_consensus_forall.log 
timeout ${Timeout} python3 run_all.py ${sym_quorum_path}simple-election.ivy               -s acceptor=1,proposer=1 -i acceptor   -k -v 5 -w -l ${sym_quorum_path}simple-election.log 
...
timeout ${Timeout} python3 run_all.py ${sym_quorum_path}consensus_epr.ivy                 -s node=1,value=1        -i node    -t -k -v 5 -w -l ${sym_quorum_path}consensus_epr.log 