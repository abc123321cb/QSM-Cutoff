...
timeout ${Timeout} python3 run_all.py ${sym_quorum_path}quorum-leader-election-wo-maj.ivy -s node=1                -i node    -m -t -k -v 5 -w -l ${sym_quorum_path}quorum-leader-election-wo-maj.check.log
