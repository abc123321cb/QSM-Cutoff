#include "consensus_epr.node_2_value_1.finite.h"
...
#include <cstdint>
#endif
typedef consensus_epr__node_2_value_1__finite ivy_class;
...
void consensus_epr__node_2_value_1__finite::install_reader(reader *r) {
    #ifdef _WIN32
...
void consensus_epr__node_2_value_1__finite::install_thread(reader *r) {
    install_reader(r);
}

void consensus_epr__node_2_value_1__finite::install_timer(timer *r) {
    #ifdef _WIN32
...
#ifdef _WIN32
    void consensus_epr__node_2_value_1__finite::__lock() { WaitForSingleObject(mutex,INFINITE); }
    void consensus_epr__node_2_value_1__finite::__unlock() { ReleaseMutex(mutex); }
#else
    void consensus_epr__node_2_value_1__finite::__lock() { pthread_mutex_lock(&mutex); }
    void consensus_epr__node_2_value_1__finite::__unlock() { pthread_mutex_unlock(&mutex); }
#endif
...
std::ostream &operator <<(std::ostream &s, const consensus_epr__node_2_value_1__finite::node &t);
template <>
consensus_epr__node_2_value_1__finite::node _arg<consensus_epr__node_2_value_1__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<consensus_epr__node_2_value_1__finite::node>(ivy_ser &res, const consensus_epr__node_2_value_1__finite::node&);
template <>
void  __deser<consensus_epr__node_2_value_1__finite::node>(ivy_deser &inp, consensus_epr__node_2_value_1__finite::node &res);
std::ostream &operator <<(std::ostream &s, const consensus_epr__node_2_value_1__finite::quorum &t);
template <>
consensus_epr__node_2_value_1__finite::quorum _arg<consensus_epr__node_2_value_1__finite::quorum>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<consensus_epr__node_2_value_1__finite::quorum>(ivy_ser &res, const consensus_epr__node_2_value_1__finite::quorum&);
template <>
void  __deser<consensus_epr__node_2_value_1__finite::quorum>(ivy_deser &inp, consensus_epr__node_2_value_1__finite::quorum &res);
std::ostream &operator <<(std::ostream &s, const consensus_epr__node_2_value_1__finite::value &t);
template <>
consensus_epr__node_2_value_1__finite::value _arg<consensus_epr__node_2_value_1__finite::value>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<consensus_epr__node_2_value_1__finite::value>(ivy_ser &res, const consensus_epr__node_2_value_1__finite::value&);
template <>
void  __deser<consensus_epr__node_2_value_1__finite::value>(ivy_deser &inp, consensus_epr__node_2_value_1__finite::value &res);
int consensus_epr__node_2_value_1__finite::___ivy_choose(int rng,const char *name,int id) {
        return 0;
    }
bool consensus_epr__node_2_value_1__finite::chosen(node N){
    bool val;
    int __tmp0;
    __tmp0 = 0;
    for (int Q = 0; Q < 1; Q++) {
...
void consensus_epr__node_2_value_1__finite::__init(){
...
void consensus_epr__node_2_value_1__finite::ext__send_request_vote(node src, node dst){
    vote_request_msg[src][dst] = true;
}
void consensus_epr__node_2_value_1__finite::ext__send_vote(node src, node dst){
    /** QRM enumerates all satisfying model for reachability **/
    static int qrm_solution_count = 0;
    const int max_qrm_solution_count = 2;
    if (qrm_solution_count == 0){
        ivy_assume(!voted[src], "consensus_epr.node_2_value_1.finite.ivy: line 33");
        ivy_assume(vote_request_msg[dst][src], "consensus_epr.node_2_value_1.finite.ivy: line 34");
...
void consensus_epr__node_2_value_1__finite::ext__recv_vote(node n, node sender){
        ivy_assume(vote_msg[sender][n], "consensus_epr.node_2_value_1.finite.ivy: line 42");
        votes[n][sender] = true;
}
void consensus_epr__node_2_value_1__finite::ext__become_leader(node n){
        ivy_assume(chosen(n), "consensus_epr.node_2_value_1.finite.ivy: line 48");
        leader[n] = true;
}
void consensus_epr__node_2_value_1__finite::ext__decide(node n, value v){
        ivy_assume(leader[n], "consensus_epr.node_2_value_1.finite.ivy: line 54");
        int __tmp8;
        __tmp8 = 1;
        for (int V = 0; V < 1; V++) {
...
bool consensus_epr__node_2_value_1__finite::ext__get_bool_vote_request_msg(node n0, node n1, bool result){
    bool qrm_result;
...
bool consensus_epr__node_2_value_1__finite::ext__get_decided(node n0, value v1){
    bool qrm_result;
    qrm_result = decided[n0][v1];
    return qrm_result;
}
bool consensus_epr__node_2_value_1__finite::ext__get_bool_decided(node n0, value v1, bool result){
    bool qrm_result;
...
bool consensus_epr__node_2_value_1__finite::ext__get_bool_voted(node n0, bool result){
    bool qrm_result;
...
bool consensus_epr__node_2_value_1__finite::ext__get_bool_member(node n0, quorum q1, bool result){
    bool qrm_result;
    qrm_result = (member[n0][q1] == result);
    return qrm_result;
}
bool consensus_epr__node_2_value_1__finite::ext__get_vote_msg(node n0, node n1){
    bool qrm_result;
...
bool consensus_epr__node_2_value_1__finite::ext__get_votes(node n0, node n1){
    bool qrm_result;
    qrm_result = votes[n0][n1];
    return qrm_result;
}
bool consensus_epr__node_2_value_1__finite::ext__get_bool_votes(node n0, node n1, bool result){
    bool qrm_result;
    qrm_result = (votes[n0][n1] == result);
    return qrm_result;
}
void consensus_epr__node_2_value_1__finite::__tick(int __timeout){
}
consensus_epr__node_2_value_1__finite::consensus_epr__node_2_value_1__finite(){
#ifdef _WIN32
...
std::ostream &operator <<(std::ostream &s, const consensus_epr__node_2_value_1__finite::node &t){
    if (t == consensus_epr__node_2_value_1__finite::node0) s<<"node0";
    if (t == consensus_epr__node_2_value_1__finite::node1) s<<"node1";
    return s;
}
template <>
void  __ser<consensus_epr__node_2_value_1__finite::node>(ivy_ser &res, const consensus_epr__node_2_value_1__finite::node&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const consensus_epr__node_2_value_1__finite::quorum &t){
    if (t == consensus_epr__node_2_value_1__finite::quorum__node0_node1) s<<"quorum__node0_node1";
    return s;
}
template <>
void  __ser<consensus_epr__node_2_value_1__finite::quorum>(ivy_ser &res, const consensus_epr__node_2_value_1__finite::quorum&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const consensus_epr__node_2_value_1__finite::value &t){
    if (t == consensus_epr__node_2_value_1__finite::value0) s<<"value0";
    return s;
}
template <>
void  __ser<consensus_epr__node_2_value_1__finite::value>(ivy_ser &res, const consensus_epr__node_2_value_1__finite::value&t){
    __ser(res,(int)t);
}
...
int ask_ret(long long bound) {
    ...
    class consensus_epr__node_2_value_1__finite_repl : public consensus_epr__node_2_value_1__finite {
    ...
    virtual void ivy_assume(bool truth,const char *msg){
        ...
        consensus_epr__node_2_value_1__finite_repl() : consensus_epr__node_2_value_1__finite(){}
...
consensus_epr__node_2_value_1__finite::node _arg<consensus_epr__node_2_value_1__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ...
    if(arg.atom == "node0") return consensus_epr__node_2_value_1__finite::node0;
    if(arg.atom == "node1") return consensus_epr__node_2_value_1__finite::node1;
...
void __deser<consensus_epr__node_2_value_1__finite::node>(ivy_deser &inp, consensus_epr__node_2_value_1__finite::node &res){
    int __res;
    __deser(inp,__res);
    res = (consensus_epr__node_2_value_1__finite::node)__res;
}
template <>
consensus_epr__node_2_value_1__finite::quorum _arg<consensus_epr__node_2_value_1__finite::quorum>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "quorum__node0_node1") return consensus_epr__node_2_value_1__finite::quorum__node0_node1;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<consensus_epr__node_2_value_1__finite::quorum>(ivy_deser &inp, consensus_epr__node_2_value_1__finite::quorum &res){
    int __res;
    __deser(inp,__res);
    res = (consensus_epr__node_2_value_1__finite::quorum)__res;
}
template <>
consensus_epr__node_2_value_1__finite::value _arg<consensus_epr__node_2_value_1__finite::value>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "value0") return consensus_epr__node_2_value_1__finite::value0;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<consensus_epr__node_2_value_1__finite::value>(ivy_deser &inp, consensus_epr__node_2_value_1__finite::value &res){
    int __res;
    __deser(inp,__res);
    res = (consensus_epr__node_2_value_1__finite::value)__res;
}
...
class cmd_reader: public stdin_reader {
    int lineno;
public:
    consensus_epr__node_2_value_1__finite_repl &ivy;    

    cmd_reader(consensus_epr__node_2_value_1__finite_repl &_ivy) : ivy(_ivy) {
        lineno = 1;
        if (isatty(fdes()))
        ...
        try {
            ...
            ivy.__lock();
                ...
                if (action == "become_leader") {
                    ...
                    ivy.ext__become_leader(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2));
                }
                else
    
                if (action == "decide") {
                    check_arity(args,2,action);
                    ivy.ext__decide(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<consensus_epr__node_2_value_1__finite::value>(args,1,1));
                }
                else
    
                if (action == "get_bool_chosen") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_chosen(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_decided") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_decided(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<consensus_epr__node_2_value_1__finite::value>(args,1,1),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_leader") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_leader(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_member") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_member(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<consensus_epr__node_2_value_1__finite::quorum>(args,1,1),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_vote_msg") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_vote_msg(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<consensus_epr__node_2_value_1__finite::node>(args,1,2),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_vote_request_msg") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_vote_request_msg(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<consensus_epr__node_2_value_1__finite::node>(args,1,2),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_voted") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_voted(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_votes") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_votes(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<consensus_epr__node_2_value_1__finite::node>(args,1,2),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_chosen") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_chosen(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2)) << std::endl;
                }
                else
    
                if (action == "get_decided") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_decided(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<consensus_epr__node_2_value_1__finite::value>(args,1,1)) << std::endl;
                }
                else
    
                if (action == "get_leader") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_leader(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2)) << std::endl;
                }
                else
    
                if (action == "get_member") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_member(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<consensus_epr__node_2_value_1__finite::quorum>(args,1,1)) << std::endl;
                }
                else
    
                if (action == "get_vote_msg") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_vote_msg(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<consensus_epr__node_2_value_1__finite::node>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_vote_request_msg") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_vote_request_msg(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<consensus_epr__node_2_value_1__finite::node>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_voted") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_voted(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2)) << std::endl;
                }
                else
    
                if (action == "get_votes") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_votes(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<consensus_epr__node_2_value_1__finite::node>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "recv_vote") {
                    check_arity(args,2,action);
                    ivy.ext__recv_vote(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<consensus_epr__node_2_value_1__finite::node>(args,1,2));
                }
                else
    
                if (action == "send_request_vote") {
                    check_arity(args,2,action);
                    ivy.ext__send_request_vote(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<consensus_epr__node_2_value_1__finite::node>(args,1,2));
                }
                else
    
                if (action == "send_vote") {
                    check_arity(args,2,action);
                    ivy.ext__send_vote(_arg<consensus_epr__node_2_value_1__finite::node>(args,0,2),_arg<consensus_epr__node_2_value_1__finite::node>(args,1,2));
                }
                else
...
int main(int argc, char **argv){
    ...
    if (argc != 1){
        std::cerr << "usage: consensus_epr__node_2_value_1__finite \n";
        __ivy_exit(1);
    }
...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[2]) >> ivy_exec -> leader[0];
	std::stringstream(state_values[3]) >> ivy_exec -> leader[1];
	std::stringstream(state_values[4]) >> ivy_exec -> vote_msg[0][0];
	std::stringstream(state_values[5]) >> ivy_exec -> vote_msg[0][1];
	std::stringstream(state_values[6]) >> ivy_exec -> vote_msg[1][0];
	std::stringstream(state_values[7]) >> ivy_exec -> vote_msg[1][1];
	std::stringstream(state_values[8]) >> ivy_exec -> vote_request_msg[0][0];
	std::stringstream(state_values[9]) >> ivy_exec -> vote_request_msg[0][1];
	std::stringstream(state_values[10]) >> ivy_exec -> vote_request_msg[1][0];
	std::stringstream(state_values[11]) >> ivy_exec -> vote_request_msg[1][1];
	std::stringstream(state_values[12]) >> ivy_exec -> voted[0];
	std::stringstream(state_values[13]) >> ivy_exec -> voted[1];
	std::stringstream(state_values[14]) >> ivy_exec -> votes[0][0];
	std::stringstream(state_values[15]) >> ivy_exec -> votes[0][1];
	std::stringstream(state_values[16]) >> ivy_exec -> votes[1][0];
	std::stringstream(state_values[17]) >> ivy_exec -> votes[1][1];
}
