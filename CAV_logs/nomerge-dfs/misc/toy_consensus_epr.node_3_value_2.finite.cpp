#include "toy_consensus_epr.node_3_value_2.finite.h"
...
#include <cstdint>
#endif
typedef toy_consensus_epr__node_3_value_2__finite ivy_class;
...
void toy_consensus_epr__node_3_value_2__finite::install_reader(reader *r) {
    #ifdef _WIN32
...
void toy_consensus_epr__node_3_value_2__finite::install_thread(reader *r) {
    install_reader(r);
}

void toy_consensus_epr__node_3_value_2__finite::install_timer(timer *r) {
    #ifdef _WIN32
...
#ifdef _WIN32
    void toy_consensus_epr__node_3_value_2__finite::__lock() { WaitForSingleObject(mutex,INFINITE); }
    void toy_consensus_epr__node_3_value_2__finite::__unlock() { ReleaseMutex(mutex); }
#else
    void toy_consensus_epr__node_3_value_2__finite::__lock() { pthread_mutex_lock(&mutex); }
    void toy_consensus_epr__node_3_value_2__finite::__unlock() { pthread_mutex_unlock(&mutex); }
#endif
...
std::ostream &operator <<(std::ostream &s, const toy_consensus_epr__node_3_value_2__finite::node &t);
template <>
toy_consensus_epr__node_3_value_2__finite::node _arg<toy_consensus_epr__node_3_value_2__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<toy_consensus_epr__node_3_value_2__finite::node>(ivy_ser &res, const toy_consensus_epr__node_3_value_2__finite::node&);
template <>
void  __deser<toy_consensus_epr__node_3_value_2__finite::node>(ivy_deser &inp, toy_consensus_epr__node_3_value_2__finite::node &res);
std::ostream &operator <<(std::ostream &s, const toy_consensus_epr__node_3_value_2__finite::quorum &t);
template <>
toy_consensus_epr__node_3_value_2__finite::quorum _arg<toy_consensus_epr__node_3_value_2__finite::quorum>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<toy_consensus_epr__node_3_value_2__finite::quorum>(ivy_ser &res, const toy_consensus_epr__node_3_value_2__finite::quorum&);
template <>
void  __deser<toy_consensus_epr__node_3_value_2__finite::quorum>(ivy_deser &inp, toy_consensus_epr__node_3_value_2__finite::quorum &res);
std::ostream &operator <<(std::ostream &s, const toy_consensus_epr__node_3_value_2__finite::value &t);
template <>
toy_consensus_epr__node_3_value_2__finite::value _arg<toy_consensus_epr__node_3_value_2__finite::value>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<toy_consensus_epr__node_3_value_2__finite::value>(ivy_ser &res, const toy_consensus_epr__node_3_value_2__finite::value&);
template <>
void  __deser<toy_consensus_epr__node_3_value_2__finite::value>(ivy_deser &inp, toy_consensus_epr__node_3_value_2__finite::value &res);
int toy_consensus_epr__node_3_value_2__finite::___ivy_choose(int rng,const char *name,int id) {
        return 0;
    }
bool toy_consensus_epr__node_3_value_2__finite::chosenAt(quorum Q, value V){
    bool val;
    int __tmp0;
    __tmp0 = 1;
    for (int N = 0; N < 3; N++) {
...
void toy_consensus_epr__node_3_value_2__finite::__init(){
...
void toy_consensus_epr__node_3_value_2__finite::ext__cast_vote(node n, value v){
        ivy_assume(!voted[n], "toy_consensus_epr.node_3_value_2.finite.ivy: line 23");
        vote[n][v] = true;
        voted[n] = true;
}
...
bool toy_consensus_epr__node_3_value_2__finite::ext__get_bool_voted(node n0, bool result){
    bool qrm_result;
    qrm_result = (voted[n0] == result);
    return qrm_result;
}
bool toy_consensus_epr__node_3_value_2__finite::ext__get_member(node n0, quorum q1){
    bool qrm_result;
    qrm_result = member[n0][q1];
    return qrm_result;
}
bool toy_consensus_epr__node_3_value_2__finite::ext__get_bool_member(node n0, quorum q1, bool result){
    bool qrm_result;
    qrm_result = (member[n0][q1] == result);
    return qrm_result;
}
bool toy_consensus_epr__node_3_value_2__finite::ext__get_decided(value v0){
    bool qrm_result;
    qrm_result = decided[v0];
    return qrm_result;
}
bool toy_consensus_epr__node_3_value_2__finite::ext__get_bool_decided(value v0, bool result){
    bool qrm_result;
...
bool toy_consensus_epr__node_3_value_2__finite::ext__get_chosenAt(quorum q0, value v1){
    bool qrm_result;
...
toy_consensus_epr__node_3_value_2__finite::toy_consensus_epr__node_3_value_2__finite(){
#ifdef _WIN32
...
std::ostream &operator <<(std::ostream &s, const toy_consensus_epr__node_3_value_2__finite::node &t){
    if (t == toy_consensus_epr__node_3_value_2__finite::node0) s<<"node0";
    if (t == toy_consensus_epr__node_3_value_2__finite::node1) s<<"node1";
    if (t == toy_consensus_epr__node_3_value_2__finite::node2) s<<"node2";
    return s;
}
template <>
void  __ser<toy_consensus_epr__node_3_value_2__finite::node>(ivy_ser &res, const toy_consensus_epr__node_3_value_2__finite::node&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const toy_consensus_epr__node_3_value_2__finite::quorum &t){
    if (t == toy_consensus_epr__node_3_value_2__finite::quorum__node0_node1) s<<"quorum__node0_node1";
    if (t == toy_consensus_epr__node_3_value_2__finite::quorum__node0_node2) s<<"quorum__node0_node2";
    if (t == toy_consensus_epr__node_3_value_2__finite::quorum__node1_node2) s<<"quorum__node1_node2";
    return s;
}
template <>
void  __ser<toy_consensus_epr__node_3_value_2__finite::quorum>(ivy_ser &res, const toy_consensus_epr__node_3_value_2__finite::quorum&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const toy_consensus_epr__node_3_value_2__finite::value &t){
    if (t == toy_consensus_epr__node_3_value_2__finite::value0) s<<"value0";
    if (t == toy_consensus_epr__node_3_value_2__finite::value1) s<<"value1";
    return s;
}
template <>
void  __ser<toy_consensus_epr__node_3_value_2__finite::value>(ivy_ser &res, const toy_consensus_epr__node_3_value_2__finite::value&t){
    __ser(res,(int)t);
}
...
int ask_ret(long long bound) {
    ...
    class toy_consensus_epr__node_3_value_2__finite_repl : public toy_consensus_epr__node_3_value_2__finite {
    ...
    virtual void ivy_assume(bool truth,const char *msg){
        ...
        toy_consensus_epr__node_3_value_2__finite_repl() : toy_consensus_epr__node_3_value_2__finite(){}
...
toy_consensus_epr__node_3_value_2__finite::node _arg<toy_consensus_epr__node_3_value_2__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ...
    if(arg.atom == "node0") return toy_consensus_epr__node_3_value_2__finite::node0;
    if(arg.atom == "node1") return toy_consensus_epr__node_3_value_2__finite::node1;
    if(arg.atom == "node2") return toy_consensus_epr__node_3_value_2__finite::node2;
...
void __deser<toy_consensus_epr__node_3_value_2__finite::node>(ivy_deser &inp, toy_consensus_epr__node_3_value_2__finite::node &res){
    int __res;
    __deser(inp,__res);
    res = (toy_consensus_epr__node_3_value_2__finite::node)__res;
}
template <>
toy_consensus_epr__node_3_value_2__finite::quorum _arg<toy_consensus_epr__node_3_value_2__finite::quorum>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "quorum__node0_node1") return toy_consensus_epr__node_3_value_2__finite::quorum__node0_node1;
    if(arg.atom == "quorum__node0_node2") return toy_consensus_epr__node_3_value_2__finite::quorum__node0_node2;
    if(arg.atom == "quorum__node1_node2") return toy_consensus_epr__node_3_value_2__finite::quorum__node1_node2;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<toy_consensus_epr__node_3_value_2__finite::quorum>(ivy_deser &inp, toy_consensus_epr__node_3_value_2__finite::quorum &res){
    int __res;
    __deser(inp,__res);
    res = (toy_consensus_epr__node_3_value_2__finite::quorum)__res;
}
template <>
toy_consensus_epr__node_3_value_2__finite::value _arg<toy_consensus_epr__node_3_value_2__finite::value>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "value0") return toy_consensus_epr__node_3_value_2__finite::value0;
    if(arg.atom == "value1") return toy_consensus_epr__node_3_value_2__finite::value1;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<toy_consensus_epr__node_3_value_2__finite::value>(ivy_deser &inp, toy_consensus_epr__node_3_value_2__finite::value &res){
    int __res;
    __deser(inp,__res);
    res = (toy_consensus_epr__node_3_value_2__finite::value)__res;
}
...
class cmd_reader: public stdin_reader {
    int lineno;
public:
    toy_consensus_epr__node_3_value_2__finite_repl &ivy;    

    cmd_reader(toy_consensus_epr__node_3_value_2__finite_repl &_ivy) : ivy(_ivy) {
        lineno = 1;
        if (isatty(fdes()))
        ...
        try {
            ...
            ivy.__lock();
                ...
                if (action == "cast_vote") {
                    ...
                    ivy.ext__cast_vote(_arg<toy_consensus_epr__node_3_value_2__finite::node>(args,0,3),_arg<toy_consensus_epr__node_3_value_2__finite::value>(args,1,2));
                }
                else
    
                if (action == "decide") {
                    check_arity(args,2,action);
                    ivy.ext__decide(_arg<toy_consensus_epr__node_3_value_2__finite::value>(args,0,2),_arg<toy_consensus_epr__node_3_value_2__finite::quorum>(args,1,3));
                }
                else
    
                if (action == "get_bool_chosenAt") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_chosenAt(_arg<toy_consensus_epr__node_3_value_2__finite::quorum>(args,0,3),_arg<toy_consensus_epr__node_3_value_2__finite::value>(args,1,2),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_decided") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_decided(_arg<toy_consensus_epr__node_3_value_2__finite::value>(args,0,2),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_member") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_member(_arg<toy_consensus_epr__node_3_value_2__finite::node>(args,0,3),_arg<toy_consensus_epr__node_3_value_2__finite::quorum>(args,1,3),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_vote") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_vote(_arg<toy_consensus_epr__node_3_value_2__finite::node>(args,0,3),_arg<toy_consensus_epr__node_3_value_2__finite::value>(args,1,2),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_voted") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_voted(_arg<toy_consensus_epr__node_3_value_2__finite::node>(args,0,3),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_chosenAt") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_chosenAt(_arg<toy_consensus_epr__node_3_value_2__finite::quorum>(args,0,3),_arg<toy_consensus_epr__node_3_value_2__finite::value>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_decided") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_decided(_arg<toy_consensus_epr__node_3_value_2__finite::value>(args,0,2)) << std::endl;
                }
                else
    
                if (action == "get_member") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_member(_arg<toy_consensus_epr__node_3_value_2__finite::node>(args,0,3),_arg<toy_consensus_epr__node_3_value_2__finite::quorum>(args,1,3)) << std::endl;
                }
                else
    
                if (action == "get_vote") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_vote(_arg<toy_consensus_epr__node_3_value_2__finite::node>(args,0,3),_arg<toy_consensus_epr__node_3_value_2__finite::value>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_voted") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_voted(_arg<toy_consensus_epr__node_3_value_2__finite::node>(args,0,3)) << std::endl;
                }
                else
...
int main(int argc, char **argv){
    ...
    if (argc != 1){
        std::cerr << "usage: toy_consensus_epr__node_3_value_2__finite \n";
        __ivy_exit(1);
    }
...
#include <vector>
toy_consensus_epr__node_3_value_2__finite_repl * ivy_exec;
cmd_reader* ivy_exec_cr;
std::ostringstream ivy_exec_stream;

void ivy_exec_init(){
	__ivy_out.basic_ios<char>::rdbuf(ivy_exec_stream.rdbuf());
	ivy_exec = new toy_consensus_epr__node_3_value_2__finite_repl;
	ivy_exec -> __unlock();
