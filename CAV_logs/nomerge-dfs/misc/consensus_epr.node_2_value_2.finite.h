...
class consensus_epr__node_2_value_2__finite {
  public:
    ...
    virtual ~consensus_epr__node_2_value_2__finite();
    ...
    enum value{value0,value1};
    enum quorum{quorum__node0_node1};
    bool member[2][1];
    bool vote_request_msg[2][2];
    bool voted[2];
    bool vote_msg[2][2];
    bool votes[2][2];
    bool leader[2];
    bool decided[2][2];
    virtual bool chosen(node N);
    consensus_epr__node_2_value_2__finite();
void __init();
    virtual void ext__send_request_vote(node src, node dst);
    virtual void ext__send_vote(node src, node dst);
    virtual void ext__recv_vote(node n, node sender);
    virtual void ext__become_leader(node n);
    virtual void ext__decide(node n, value v);
    virtual bool ext__get_vote_request_msg(node n0, node n1);
    virtual bool ext__get_bool_vote_request_msg(node n0, node n1, bool result);
    virtual bool ext__get_chosen(node n0);
    virtual bool ext__get_bool_chosen(node n0, bool result);
    virtual bool ext__get_voted(node n0);
    virtual bool ext__get_bool_voted(node n0, bool result);
    virtual bool ext__get_leader(node n0);
    virtual bool ext__get_bool_leader(node n0, bool result);
    virtual bool ext__get_member(node n0, quorum q1);
    virtual bool ext__get_bool_member(node n0, quorum q1, bool result);
    virtual bool ext__get_decided(node n0, value v1);
    virtual bool ext__get_bool_decided(node n0, value v1, bool result);
    virtual bool ext__get_vote_msg(node n0, node n1);
    virtual bool ext__get_bool_vote_msg(node n0, node n1, bool result);
    virtual bool ext__get_votes(node n0, node n1);
    virtual bool ext__get_bool_votes(node n0, node n1, bool result);
