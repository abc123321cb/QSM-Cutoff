...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[3]) >> ivy_exec -> held;
	...
	std::stringstream(state_values[9]) >> ivy_exec -> lock_msg[2];
	std::stringstream(state_values[10]) >> ivy_exec -> unlock_msg[0];
	std::stringstream(state_values[11]) >> ivy_exec -> unlock_msg[1];
	std::stringstream(state_values[12]) >> ivy_exec -> unlock_msg[2];
}
