...
simple_decentralized_lock__node_2__finite::node simple_decentralized_lock__node_2__finite::ext__get_start_node(){
    simple_decentralized_lock__node_2__finite::node qrm_result;
...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[2]) >> ivy_exec -> message[0][0];
	std::stringstream(state_values[3]) >> ivy_exec -> message[0][1];
	std::stringstream(state_values[4]) >> ivy_exec -> message[1][0];
	std::stringstream(state_values[5]) >> ivy_exec -> message[1][1];
	{
