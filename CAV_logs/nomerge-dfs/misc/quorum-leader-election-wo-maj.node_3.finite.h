...
class quorum_leader_election_wo_maj__node_3__finite {
  public:
    ...
    virtual ~quorum_leader_election_wo_maj__node_3__finite();
    ...
    enum nset{nset__node0_node1,nset__node0_node2,nset__node1_node2};
    bool isleader[3];
    bool voted[3][3];
    bool member[3][3];
    nset quorum;
    quorum_leader_election_wo_maj__node_3__finite();
void __init();
