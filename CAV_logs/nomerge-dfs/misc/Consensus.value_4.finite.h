...
class Consensus__value_4__finite {
  public:
    ...
    virtual ~Consensus__value_4__finite();
    ...
    bool chosen[4];
    Consensus__value_4__finite();
void __init();
    virtual void ext__choose(value v);
    virtual bool ext__get_chosen(value v0);
    virtual bool ext__get_bool_chosen(value v0, bool result);
