...
(assert
 ...
 (let (($x23 (not $x19)))
 (let (($x36 (or (and $x10 $x13 $x15) (and $x13 $x17 $x15) (and $x19 $x10 $x15) (and $x14 $x19 $x21) (and $x14 $x10 $x23) (and $x19 $x17 $x15) (and $x13 $x26 $x21 $x15) (and $x10 $x23 $x28 $x15) (and $x14 $x23 (not $x30) $x21) (and $x19 $x26 $x21 $x15) (and $x17 $x23 $x28 $x15) (and $x30 $x26 $x21 $x15))))
 (and (not $x36)))))))))))))))
(assert
