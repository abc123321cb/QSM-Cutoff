...
class McMillan_Example3__node_4__finite {
  public:
    ...
    virtual ~McMillan_Example3__node_4__finite();
    ...
    bool q[4];
    bool r[4];
    McMillan_Example3__node_4__finite();
void __init();
    virtual void ext__upq(node x, node y);
    virtual void ext__upr(node x, node y);
    virtual void ext__downq(node x, node y);
    virtual void ext__downr(node x, node y);
    virtual bool ext__get_p(node n0);
    virtual bool ext__get_bool_p(node n0, bool result);
    virtual bool ext__get_q(node n0);
    virtual bool ext__get_bool_q(node n0, bool result);
    virtual bool ext__get_r(node n0);
    virtual bool ext__get_bool_r(node n0, bool result);
