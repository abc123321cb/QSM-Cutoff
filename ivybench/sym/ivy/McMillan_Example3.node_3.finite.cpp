#include "McMillan_Example3.node_3.finite.h"
...
#include <cstdint>
#endif
typedef McMillan_Example3__node_3__finite ivy_class;
...
void McMillan_Example3__node_3__finite::install_reader(reader *r) {
    #ifdef _WIN32
...
void McMillan_Example3__node_3__finite::install_thread(reader *r) {
    install_reader(r);
}

void McMillan_Example3__node_3__finite::install_timer(timer *r) {
    #ifdef _WIN32
...
#ifdef _WIN32
    void McMillan_Example3__node_3__finite::__lock() { WaitForSingleObject(mutex,INFINITE); }
    void McMillan_Example3__node_3__finite::__unlock() { ReleaseMutex(mutex); }
#else
    void McMillan_Example3__node_3__finite::__lock() { pthread_mutex_lock(&mutex); }
    void McMillan_Example3__node_3__finite::__unlock() { pthread_mutex_unlock(&mutex); }
#endif
...
std::ostream &operator <<(std::ostream &s, const McMillan_Example3__node_3__finite::node &t);
template <>
McMillan_Example3__node_3__finite::node _arg<McMillan_Example3__node_3__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<McMillan_Example3__node_3__finite::node>(ivy_ser &res, const McMillan_Example3__node_3__finite::node&);
template <>
void  __deser<McMillan_Example3__node_3__finite::node>(ivy_deser &inp, McMillan_Example3__node_3__finite::node &res);
int McMillan_Example3__node_3__finite::___ivy_choose(int rng,const char *name,int id) {
        return 0;
    }
struct ivy_nondet_except {}; // lauren-yrluo added
void McMillan_Example3__node_3__finite::__init(){
        bool __tmp0[3];
        for (int X = 0; X < 3; X++) {
            __tmp0[X] = false;
        }
...
void McMillan_Example3__node_3__finite::ext__upq(node x, node y){
        ivy_assume((!p[x] && !q[y]), "McMillan_Example3.node_3.finite.ivy: line 16");
        p[x] = true;
        q[y] = true;
}
void McMillan_Example3__node_3__finite::ext__upr(node x, node y){
        ivy_assume((!p[x] && !r[y]), "McMillan_Example3.node_3.finite.ivy: line 22");
        p[x] = true;
        r[y] = true;
}
void McMillan_Example3__node_3__finite::ext__downq(node x, node y){
        ivy_assume((p[x] && q[y]), "McMillan_Example3.node_3.finite.ivy: line 28");
        p[x] = false;
        q[y] = false;
}
void McMillan_Example3__node_3__finite::ext__downr(node x, node y){
        ivy_assume((p[x] && r[y]), "McMillan_Example3.node_3.finite.ivy: line 34");
        p[x] = false;
        r[y] = false;
}
bool McMillan_Example3__node_3__finite::ext__get_q(node n0){
    bool qrm_result;
    qrm_result = q[n0];
    return qrm_result;
}
bool McMillan_Example3__node_3__finite::ext__get_bool_q(node n0, bool result){
    bool qrm_result;
    qrm_result = (q[n0] == result);
    return qrm_result;
}
bool McMillan_Example3__node_3__finite::ext__get_p(node n0){
    bool qrm_result;
    qrm_result = p[n0];
    return qrm_result;
}
bool McMillan_Example3__node_3__finite::ext__get_bool_p(node n0, bool result){
    bool qrm_result;
    qrm_result = (p[n0] == result);
    return qrm_result;
}
bool McMillan_Example3__node_3__finite::ext__get_r(node n0){
    bool qrm_result;
    qrm_result = r[n0];
    return qrm_result;
}
bool McMillan_Example3__node_3__finite::ext__get_bool_r(node n0, bool result){
    bool qrm_result;
    qrm_result = (r[n0] == result);
    return qrm_result;
}
void McMillan_Example3__node_3__finite::__tick(int __timeout){
}
McMillan_Example3__node_3__finite::McMillan_Example3__node_3__finite(){
#ifdef _WIN32
...
std::ostream &operator <<(std::ostream &s, const McMillan_Example3__node_3__finite::node &t){
    if (t == McMillan_Example3__node_3__finite::node0) s<<"node0";
    if (t == McMillan_Example3__node_3__finite::node1) s<<"node1";
    if (t == McMillan_Example3__node_3__finite::node2) s<<"node2";
    return s;
}
template <>
void  __ser<McMillan_Example3__node_3__finite::node>(ivy_ser &res, const McMillan_Example3__node_3__finite::node&t){
    __ser(res,(int)t);
}
...
int ask_ret(long long bound) {
    ...
    class McMillan_Example3__node_3__finite_repl : public McMillan_Example3__node_3__finite {
    ...
    virtual void ivy_assume(bool truth,const char *msg){
        ...
        McMillan_Example3__node_3__finite_repl() : McMillan_Example3__node_3__finite(){}
...
McMillan_Example3__node_3__finite::node _arg<McMillan_Example3__node_3__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ...
    if(arg.atom == "node0") return McMillan_Example3__node_3__finite::node0;
    if(arg.atom == "node1") return McMillan_Example3__node_3__finite::node1;
    if(arg.atom == "node2") return McMillan_Example3__node_3__finite::node2;
...
void __deser<McMillan_Example3__node_3__finite::node>(ivy_deser &inp, McMillan_Example3__node_3__finite::node &res){
    int __res;
    __deser(inp,__res);
    res = (McMillan_Example3__node_3__finite::node)__res;
}
...
class cmd_reader: public stdin_reader {
    int lineno;
public:
    McMillan_Example3__node_3__finite_repl &ivy;    

    cmd_reader(McMillan_Example3__node_3__finite_repl &_ivy) : ivy(_ivy) {
        lineno = 1;
        if (isatty(fdes()))
        ...
        try {
            ...
            ivy.__lock();
                ...
                if (action == "downq") {
                    ...
                    ivy.ext__downq(_arg<McMillan_Example3__node_3__finite::node>(args,0,3),_arg<McMillan_Example3__node_3__finite::node>(args,1,3));
                }
                else
    
                if (action == "downr") {
                    check_arity(args,2,action);
                    ivy.ext__downr(_arg<McMillan_Example3__node_3__finite::node>(args,0,3),_arg<McMillan_Example3__node_3__finite::node>(args,1,3));
                }
                else
    
                if (action == "get_bool_p") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_p(_arg<McMillan_Example3__node_3__finite::node>(args,0,3),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_q") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_q(_arg<McMillan_Example3__node_3__finite::node>(args,0,3),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_r") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_r(_arg<McMillan_Example3__node_3__finite::node>(args,0,3),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_p") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_p(_arg<McMillan_Example3__node_3__finite::node>(args,0,3)) << std::endl;
                }
                else
    
                if (action == "get_q") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_q(_arg<McMillan_Example3__node_3__finite::node>(args,0,3)) << std::endl;
                }
                else
    
                if (action == "get_r") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_r(_arg<McMillan_Example3__node_3__finite::node>(args,0,3)) << std::endl;
                }
                else
    
                if (action == "upq") {
                    check_arity(args,2,action);
                    ivy.ext__upq(_arg<McMillan_Example3__node_3__finite::node>(args,0,3),_arg<McMillan_Example3__node_3__finite::node>(args,1,3));
                }
                else
    
                if (action == "upr") {
                    check_arity(args,2,action);
                    ivy.ext__upr(_arg<McMillan_Example3__node_3__finite::node>(args,0,3),_arg<McMillan_Example3__node_3__finite::node>(args,1,3));
                }
                else
...
int main(int argc, char **argv){
    ...
    if (argc != 1){
        std::cerr << "usage: McMillan_Example3__node_3__finite \n";
        __ivy_exit(1);
    }
...
void ivy_exec_set_state(std::vector<std::string> state_values){
	...
	std::stringstream(state_values[3]) >> ivy_exec -> q[0];
	std::stringstream(state_values[4]) >> ivy_exec -> q[1];
	std::stringstream(state_values[5]) >> ivy_exec -> q[2];
	std::stringstream(state_values[6]) >> ivy_exec -> r[0];
	std::stringstream(state_values[7]) >> ivy_exec -> r[1];
	std::stringstream(state_values[8]) >> ivy_exec -> r[2];
}
