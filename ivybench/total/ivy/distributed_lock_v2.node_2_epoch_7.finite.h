...
class distributed_lock_v2__node_2_epoch_7__finite {
  public:
    ...
    virtual ~distributed_lock_v2__node_2_epoch_7__finite();
    ...
    enum epoch{epoch0,epoch1,epoch2,epoch3,epoch4,epoch5,epoch6};
    bool le[7][7];
    epoch zero;
    epoch max;
    epoch ep[2];
    ...
    node first;
    epoch firste;
    distributed_lock_v2__node_2_epoch_7__finite();
void __init();
    virtual void ext__grant(node n1, node n2, epoch e);
    virtual void ext__accept(node n, epoch e);
    virtual bool ext__get_locked(epoch e0, node n1);
    virtual bool ext__get_bool_locked(epoch e0, node n1, bool result);
    virtual epoch ext__get_zero();
    virtual bool ext__get_bool_zero(epoch result);
    virtual epoch ext__get_ep(node n0);
    virtual bool ext__get_bool_ep(node n0, epoch result);
    virtual bool ext__get_held(node n0);
    virtual bool ext__get_bool_held(node n0, bool result);
    virtual node ext__get_first();
    virtual bool ext__get_bool_first(node result);
    virtual epoch ext__get_firste();
    virtual bool ext__get_bool_firste(epoch result);
    virtual bool ext__get_transfer(epoch e0, node n1);
    virtual bool ext__get_bool_transfer(epoch e0, node n1, bool result);
    virtual bool ext__get_le(epoch e0, epoch e1);
    virtual bool ext__get_bool_le(epoch e0, epoch e1, bool result);
    virtual epoch ext__get_max();
    virtual bool ext__get_bool_max(epoch result);
