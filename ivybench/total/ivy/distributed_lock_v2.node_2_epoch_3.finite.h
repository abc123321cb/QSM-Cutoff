...
class distributed_lock_v2__node_2_epoch_3__finite {
  public:
    ...
    virtual ~distributed_lock_v2__node_2_epoch_3__finite();
    ...
    enum epoch{epoch0,epoch1,epoch2};
    bool le[3][3];
    epoch zero;
    epoch max;
    epoch ep[2];
    ...
    node first;
    epoch firste;
    distributed_lock_v2__node_2_epoch_3__finite();
void __init();
