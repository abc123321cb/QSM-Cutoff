...
class distributed_lock_v2__node_4_epoch_5__finite {
  public:
    ...
    virtual ~distributed_lock_v2__node_4_epoch_5__finite();
    ...
    enum node{node0,node1,node2,node3};
    enum epoch{epoch0,epoch1,epoch2,epoch3,epoch4};
    bool le[5][5];
    epoch zero;
    epoch max;
    epoch ep[4];
    ...
    node first;
    epoch firste;
    distributed_lock_v2__node_4_epoch_5__finite();
void __init();
