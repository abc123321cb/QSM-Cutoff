#include "distributed_lock_v2.node_2_epoch_6.finite.h"
...
#include <cstdint>
#endif
typedef distributed_lock_v2__node_2_epoch_6__finite ivy_class;
...
void distributed_lock_v2__node_2_epoch_6__finite::install_reader(reader *r) {
    #ifdef _WIN32
...
void distributed_lock_v2__node_2_epoch_6__finite::install_thread(reader *r) {
    install_reader(r);
}

void distributed_lock_v2__node_2_epoch_6__finite::install_timer(timer *r) {
    #ifdef _WIN32
...
#ifdef _WIN32
    void distributed_lock_v2__node_2_epoch_6__finite::__lock() { WaitForSingleObject(mutex,INFINITE); }
    void distributed_lock_v2__node_2_epoch_6__finite::__unlock() { ReleaseMutex(mutex); }
#else
    void distributed_lock_v2__node_2_epoch_6__finite::__lock() { pthread_mutex_lock(&mutex); }
    void distributed_lock_v2__node_2_epoch_6__finite::__unlock() { pthread_mutex_unlock(&mutex); }
#endif
...
std::ostream &operator <<(std::ostream &s, const distributed_lock_v2__node_2_epoch_6__finite::epoch &t);
template <>
distributed_lock_v2__node_2_epoch_6__finite::epoch _arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<distributed_lock_v2__node_2_epoch_6__finite::epoch>(ivy_ser &res, const distributed_lock_v2__node_2_epoch_6__finite::epoch&);
template <>
void  __deser<distributed_lock_v2__node_2_epoch_6__finite::epoch>(ivy_deser &inp, distributed_lock_v2__node_2_epoch_6__finite::epoch &res);
std::ostream &operator <<(std::ostream &s, const distributed_lock_v2__node_2_epoch_6__finite::node &t);
template <>
distributed_lock_v2__node_2_epoch_6__finite::node _arg<distributed_lock_v2__node_2_epoch_6__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound);
template <>
void  __ser<distributed_lock_v2__node_2_epoch_6__finite::node>(ivy_ser &res, const distributed_lock_v2__node_2_epoch_6__finite::node&);
template <>
void  __deser<distributed_lock_v2__node_2_epoch_6__finite::node>(ivy_deser &inp, distributed_lock_v2__node_2_epoch_6__finite::node &res);
int distributed_lock_v2__node_2_epoch_6__finite::___ivy_choose(int rng,const char *name,int id) {
        return 0;
    }
struct ivy_nondet_except {}; // lauren-yrluo added
void distributed_lock_v2__node_2_epoch_6__finite::__init(){
...
void distributed_lock_v2__node_2_epoch_6__finite::ext__grant(node n1, node n2, epoch e){
        ivy_assume(held[n1], "distributed_lock_v2.node_2_epoch_6.finite.ivy: line 65");
        ivy_assume(!le[e][ep[n1]], "distributed_lock_v2.node_2_epoch_6.finite.ivy: line 66");
        int __tmp4;
        __tmp4 = 1;
        for (int E2 = 0; E2 < 6; E2++) {
            if (!(!(le[ep[n1]][E2] && le[E2][e]) || ((E2 == ep[n1]) || (E2 == e)))) __tmp4 = 0;
        }
        ivy_assume(__tmp4, "distributed_lock_v2.node_2_epoch_6.finite.ivy: line 68");
        transfer[e][n2] = true;
        held[n1] = false;
}
void distributed_lock_v2__node_2_epoch_6__finite::ext__accept(node n, epoch e){
        ivy_assume(transfer[e][n], "distributed_lock_v2.node_2_epoch_6.finite.ivy: line 75");
        ivy_assume(!le[e][ep[n]], "distributed_lock_v2.node_2_epoch_6.finite.ivy: line 76");
        transfer[e][n] = false;
        held[n] = true;
        ep[n] = e;
        locked[e][n] = true;
...
bool distributed_lock_v2__node_2_epoch_6__finite::ext__get_bool_le(epoch e0, epoch e1, bool result){
    bool qrm_result;
...
bool distributed_lock_v2__node_2_epoch_6__finite::ext__get_bool_held(node n0, bool result){
    bool qrm_result;
    qrm_result = (held[n0] == result);
    return qrm_result;
}
bool distributed_lock_v2__node_2_epoch_6__finite::ext__get_locked(epoch e0, node n1){
    bool qrm_result;
    qrm_result = locked[e0][n1];
    return qrm_result;
}
bool distributed_lock_v2__node_2_epoch_6__finite::ext__get_bool_locked(epoch e0, node n1, bool result){
    bool qrm_result;
...
distributed_lock_v2__node_2_epoch_6__finite::distributed_lock_v2__node_2_epoch_6__finite(){
#ifdef _WIN32
...
std::ostream &operator <<(std::ostream &s, const distributed_lock_v2__node_2_epoch_6__finite::epoch &t){
    if (t == distributed_lock_v2__node_2_epoch_6__finite::epoch0) s<<"epoch0";
    if (t == distributed_lock_v2__node_2_epoch_6__finite::epoch1) s<<"epoch1";
    if (t == distributed_lock_v2__node_2_epoch_6__finite::epoch2) s<<"epoch2";
    if (t == distributed_lock_v2__node_2_epoch_6__finite::epoch3) s<<"epoch3";
    if (t == distributed_lock_v2__node_2_epoch_6__finite::epoch4) s<<"epoch4";
    if (t == distributed_lock_v2__node_2_epoch_6__finite::epoch5) s<<"epoch5";
    return s;
}
template <>
void  __ser<distributed_lock_v2__node_2_epoch_6__finite::epoch>(ivy_ser &res, const distributed_lock_v2__node_2_epoch_6__finite::epoch&t){
    __ser(res,(int)t);
}
std::ostream &operator <<(std::ostream &s, const distributed_lock_v2__node_2_epoch_6__finite::node &t){
    if (t == distributed_lock_v2__node_2_epoch_6__finite::node0) s<<"node0";
    if (t == distributed_lock_v2__node_2_epoch_6__finite::node1) s<<"node1";
    return s;
}
template <>
void  __ser<distributed_lock_v2__node_2_epoch_6__finite::node>(ivy_ser &res, const distributed_lock_v2__node_2_epoch_6__finite::node&t){
    __ser(res,(int)t);
}
...
int ask_ret(long long bound) {
    ...
    class distributed_lock_v2__node_2_epoch_6__finite_repl : public distributed_lock_v2__node_2_epoch_6__finite {
    ...
    virtual void ivy_assume(bool truth,const char *msg){
        ...
        distributed_lock_v2__node_2_epoch_6__finite_repl() : distributed_lock_v2__node_2_epoch_6__finite(){}
...
distributed_lock_v2__node_2_epoch_6__finite::epoch _arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ...
    if(arg.atom == "epoch0") return distributed_lock_v2__node_2_epoch_6__finite::epoch0;
    if(arg.atom == "epoch1") return distributed_lock_v2__node_2_epoch_6__finite::epoch1;
    if(arg.atom == "epoch2") return distributed_lock_v2__node_2_epoch_6__finite::epoch2;
    if(arg.atom == "epoch3") return distributed_lock_v2__node_2_epoch_6__finite::epoch3;
    if(arg.atom == "epoch4") return distributed_lock_v2__node_2_epoch_6__finite::epoch4;
    if(arg.atom == "epoch5") return distributed_lock_v2__node_2_epoch_6__finite::epoch5;
...
void __deser<distributed_lock_v2__node_2_epoch_6__finite::epoch>(ivy_deser &inp, distributed_lock_v2__node_2_epoch_6__finite::epoch &res){
    int __res;
    __deser(inp,__res);
    res = (distributed_lock_v2__node_2_epoch_6__finite::epoch)__res;
}
template <>
distributed_lock_v2__node_2_epoch_6__finite::node _arg<distributed_lock_v2__node_2_epoch_6__finite::node>(std::vector<ivy_value> &args, unsigned idx, long long bound){
    ivy_value &arg = args[idx];
    if (arg.atom.size() == 0 || arg.fields.size() != 0) throw out_of_bounds(idx,arg.pos);
    if(arg.atom == "node0") return distributed_lock_v2__node_2_epoch_6__finite::node0;
    if(arg.atom == "node1") return distributed_lock_v2__node_2_epoch_6__finite::node1;
    throw out_of_bounds("bad value: " + arg.atom,arg.pos);
}
template <>
void __deser<distributed_lock_v2__node_2_epoch_6__finite::node>(ivy_deser &inp, distributed_lock_v2__node_2_epoch_6__finite::node &res){
    int __res;
    __deser(inp,__res);
    res = (distributed_lock_v2__node_2_epoch_6__finite::node)__res;
}
...
class cmd_reader: public stdin_reader {
    int lineno;
public:
    distributed_lock_v2__node_2_epoch_6__finite_repl &ivy;    

    cmd_reader(distributed_lock_v2__node_2_epoch_6__finite_repl &_ivy) : ivy(_ivy) {
        lineno = 1;
        if (isatty(fdes()))
        ...
        try {
            ...
            ivy.__lock();
                ...
                if (action == "accept") {
                    ...
                    ivy.ext__accept(_arg<distributed_lock_v2__node_2_epoch_6__finite::node>(args,0,2),_arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args,1,6));
                }
                else
    
                if (action == "get_bool_ep") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_ep(_arg<distributed_lock_v2__node_2_epoch_6__finite::node>(args,0,2),_arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args,1,6)) << std::endl;
                }
                else
    
                if (action == "get_bool_first") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_first(_arg<distributed_lock_v2__node_2_epoch_6__finite::node>(args,0,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_firste") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_firste(_arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args,0,6)) << std::endl;
                }
                else
    
                if (action == "get_bool_held") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_held(_arg<distributed_lock_v2__node_2_epoch_6__finite::node>(args,0,2),_arg<bool>(args,1,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_le") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_le(_arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args,0,6),_arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args,1,6),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_locked") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_locked(_arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args,0,6),_arg<distributed_lock_v2__node_2_epoch_6__finite::node>(args,1,2),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_max") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_max(_arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args,0,6)) << std::endl;
                }
                else
    
                if (action == "get_bool_transfer") {
                    check_arity(args,3,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_transfer(_arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args,0,6),_arg<distributed_lock_v2__node_2_epoch_6__finite::node>(args,1,2),_arg<bool>(args,2,2)) << std::endl;
                }
                else
    
                if (action == "get_bool_zero") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_bool_zero(_arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args,0,6)) << std::endl;
                }
                else
    
                if (action == "get_ep") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_ep(_arg<distributed_lock_v2__node_2_epoch_6__finite::node>(args,0,2)) << std::endl;
                }
                else
                ...
                if (action == "get_held") {
                    check_arity(args,1,action);
                    __ivy_out  << "= " << ivy.ext__get_held(_arg<distributed_lock_v2__node_2_epoch_6__finite::node>(args,0,2)) << std::endl;
                }
                else
    
                if (action == "get_le") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_le(_arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args,0,6),_arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args,1,6)) << std::endl;
                }
                else
    
                if (action == "get_locked") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_locked(_arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args,0,6),_arg<distributed_lock_v2__node_2_epoch_6__finite::node>(args,1,2)) << std::endl;
                }
                else
                ...
                if (action == "get_transfer") {
                    check_arity(args,2,action);
                    __ivy_out  << "= " << ivy.ext__get_transfer(_arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args,0,6),_arg<distributed_lock_v2__node_2_epoch_6__finite::node>(args,1,2)) << std::endl;
                }
                else
                ...
                if (action == "grant") {
                    check_arity(args,3,action);
                    ivy.ext__grant(_arg<distributed_lock_v2__node_2_epoch_6__finite::node>(args,0,2),_arg<distributed_lock_v2__node_2_epoch_6__finite::node>(args,1,2),_arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args,2,6));
                }
                else
...
int main(int argc, char **argv){
    ...
    if (argc != 1){
        std::cerr << "usage: distributed_lock_v2__node_2_epoch_6__finite \n";
        __ivy_exit(1);
    }
...
#include <vector>
distributed_lock_v2__node_2_epoch_6__finite_repl * ivy_exec;
cmd_reader* ivy_exec_cr;
std::ostringstream ivy_exec_stream;

void ivy_exec_init(){
	__ivy_out.basic_ios<char>::rdbuf(ivy_exec_stream.rdbuf());
	ivy_exec = new distributed_lock_v2__node_2_epoch_6__finite_repl;
	ivy_exec -> __unlock();
...
void ivy_exec_set_state(std::vector<std::string> state_values){
	{
		...
		ivy_exec -> ep[0] = _arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args, 0, 0);
	}
	{
		ivy_value arg; arg.pos = 0; arg.atom = state_values[1];
		std::vector<ivy_value> args; args.push_back(arg);
		ivy_exec -> ep[1] = _arg<distributed_lock_v2__node_2_epoch_6__finite::epoch>(args, 0, 0);
	}
