...
class distributed_lock_v2__node_2_epoch_4__finite {
  public:
    ...
    virtual ~distributed_lock_v2__node_2_epoch_4__finite();
    ...
    enum epoch{epoch0,epoch1,epoch2,epoch3};
    bool le[4][4];
    epoch zero;
    epoch max;
    epoch ep[2];
    ...
    node first;
    epoch firste;
    distributed_lock_v2__node_2_epoch_4__finite();
void __init();
