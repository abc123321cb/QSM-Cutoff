...
class distributed_lock_v2__node_2_epoch_6__finite {
  public:
    ...
    virtual ~distributed_lock_v2__node_2_epoch_6__finite();
    ...
    enum epoch{epoch0,epoch1,epoch2,epoch3,epoch4,epoch5};
    bool le[6][6];
    epoch zero;
    epoch max;
    epoch ep[2];
    ...
    node first;
    epoch firste;
    distributed_lock_v2__node_2_epoch_6__finite();
void __init();
